...
export declare class ApplicationHeader {
    ...
    hasSlottedLogo: boolean;
    hasOverflowContextMenu: boolean;
    hasSecondarySlotElements: boolean;
    hasDefaultSlotElements: boolean;
    hasOverflowSlotElements: boolean;
    ...
    get contentBackground(): Element | null;
