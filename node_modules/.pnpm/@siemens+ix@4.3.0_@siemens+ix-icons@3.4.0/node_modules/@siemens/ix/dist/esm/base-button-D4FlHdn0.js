...
const BaseButton = (props, children) => {
    ...
    const buttonContent = [
        ...
        props.icon && !props.loading ? (h("ix-icon", { class: "icon", name: props.icon, size: props.iconSize, color: props.iconColor, "aria-hidden": iconIsDecorative ? 'true' : undefined })) : null,
        h("div", { class: {
                content: true,
                [`content-${props.alignment}`]: !!props.alignment,
            } }, children),
        props.iconRight ? (h("ix-icon", { class: "icon-right", name: props.iconRight, size: props.iconSize, color: props.iconColor, "aria-hidden": iconIsDecorative ? 'true' : undefined })) : null,
...
//# sourceMappingURL=base-button-D4FlHdn0.js.map
