...
const Pill = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '92cc7c2458f3bbf26a62fb641a6a69c279aca3d4', style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': this.pillColor,
                }
                : {}, class: {
                'align-left': this.alignLeft,
            } }, index.h("div", { key: '4b6a3abf6c93b8d8705e9e95738b0e2f1b270465', ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
                container: true,
            ...
            } }, this.icon && (index.h("ix-icon", { key: '4739a22536b12b5124fc11a6f72f664539c2b662', class: {
                'with-icon': true,
            }, name: this.icon, size: '16', "aria-label": this.ariaLabelIcon })), index.h("span", { key: '90457e143210a0f070b775ba176aa35946e910c6', class: "slot-container" }, index.h("slot", { key: 'bd7e9da045b7536b65a4c92ec37197bbfda0b478', onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip()));
    }
