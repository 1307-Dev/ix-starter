...
const Drawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '97ae2273ad9c603d477907a07cba1e1477e9611d', class: {
                ...
                overflow: 'hidden',
            }, ref: (el) => (this.divElement = el), "data-testid": "container", id: "div-container" }, index.h("div", { key: '01ce6e66f3460299967c678cded87b96d6967445', style: {
                width: this.width === 'auto'
                    ? 'auto'
                    : `${this.getConstrainedWidth(this.width)}rem`,
            } }, index.h("div", { key: 'f4c040460d4917c8289b3746158696ed20c92d20', class: "header" }, index.h("div", { key: '0a05c91318f6c67c8a802b35970f321dbba55dbe', class: "header-content" }, index.h("slot", { key: '853415c470b8c34b70ef8e95be2fc44629f6eb62', name: "header" })), index.h("ix-icon-button", { key: '47cb76743364e504a287c218b62d8ff82f92276b', class: "close-button", style: {
                display: this.showContent ? 'block' : 'none',
            }, icon: index$1.iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.onCloseClicked(), "data-testid": "close-button", "aria-label": this.ariaLabelCloseButton })), index.h("div", { key: '427f1fea6a16c11291998c40ecfe80599b0dcf75', class: "content", style: {
                display: this.showContent ? 'block' : 'none',
            } }, index.h("slot", { key: 'b5471ae2a3a59ede24fcf6deeb323bd2ab6acf4a' })))));
    }
