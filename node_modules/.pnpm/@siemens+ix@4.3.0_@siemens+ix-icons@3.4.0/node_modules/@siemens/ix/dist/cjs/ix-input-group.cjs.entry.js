...
const InputGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b148a7e4ed2a11c543a98a6247797da3415b9bba', class: { disabled: this.disabled } }, index.h("div", { key: '6aac120f6d3cad989a4409978760fb752c556711', class: "group group-start" }, index.h("slot", { key: 'f2b68f9fd6b449b560823db825f04a6d154baf91', ref: (el) => (this.startSlotRef = el), name: "input-start" })), index.h("slot", { key: '7aa651f145806d7c24ad00af93d9dfd267a9ce02' }), index.h("div", { key: 'd6214bd6949bd22bdc62582d0f0089f884b5c6af', class: "group group-end" }, index.h("slot", { key: '8eb65c2a35f67a2436c58cc8b04605f4d80b74f2', ref: (el) => (this.endSlotRef = el), name: "input-end" }))));
    }
