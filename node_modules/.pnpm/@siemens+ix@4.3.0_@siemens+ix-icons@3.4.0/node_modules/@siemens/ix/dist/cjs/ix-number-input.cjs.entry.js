...
const NumberInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '17c1ce40e1018c0e1dab393a8f43aeb21d018abc', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: 'b666f6c1d8cbb64032ee41a527da32cebd77ea0d', id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: 'f7bac1c0267387467cba5c578317a211907a2e20', class: {
                'input-wrapper': true,
                'show-stepper-buttons': !!this.showStepperButtons,
            } }, index.h(input_fc.SlotStart, { key: 'f631fa994ca763a4a082d0b385a51909ae069f4d', slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h(input_fc.InputElement, { key: '1ee725bff9ec089c6d748eb9e9182f33f07b8900', id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, step: this.step, min: this.min, max: this.max, pattern: this.pattern, type: 'number', isInvalid: this.isInvalid, required: this.required, value: this.formatValue(this.value), placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => input_fc.checkAllowedKeys(this, event), onKeyDown: (event) => this.handleKeyDown(event), onBeforeInput: (event) => this.handleBeforeInput(event), onPaste: (event) => this.handlePaste(event), valueChange: this.handleInputChange, updateFormInternalValue: (value) => {
                const isScientificNotation = this.isScientificNotation(value.trim());
                if (!isScientificNotation) {
                    const parsedValue = this.convertNumberStringToFloat(value);
                    this.updateFormInternalValue(parsedValue);
                }
            }, onBlur: this.handleBlur, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : undefined, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), index.h(input_fc.SlotEnd, { key: 'dae5e8e30107d43826ffee896b27579b9acad56d', slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("div", { key: '411cb729fcff7d39a60d17b722f68b00766714dd', class: {
                'number-stepper-container': true,
                'container-hidden': !showStepperButtons,
            } }, index.h("ix-icon-button", { key: 'c410d5feadfc808702aad9b8f0d4566a43c38079', variant: "subtle-tertiary", icon: index$1.iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => this.handleStepOperation('down') }), index.h("ix-icon-button", { key: 'fc1da3c2072bf096f42878df84f367ac62f6d520', variant: "subtle-tertiary", icon: index$1.iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => this.handleStepOperation('up') })))))));
    }
