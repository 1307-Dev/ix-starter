...
const Pane = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5655829a1a9d23b744cde83c51912a44c297c0be', class: {
            ...
            }, "aria-expanded": a11y.a11yBoolean(this.expanded) }, index.h("aside", { key: 'c354042a5d5c30be1e13602b26be9c59c9d6e293', id: `pane-${this.composition}`, class: {
                'top-bottom-pane': this.isBottomTopPane && !this.isMobile,
                'left-right-pane': this.isLeftRightPane && !this.isMobile,
                'mobile-pane': this.isMobile,
                expanded: this.expanded,
            } }, index.h("div", { key: '7b5115f90b02f1eeb4086e9a39abaf7f3a9f2301', id: "title-div", class: {
            ...
            } }, index.h("ix-icon-button", { key: 'b10c65e60762410373d745a4514fe7bc0a774b7c', class: "title-icon", size: "24", icon: this.expanded
                ? this.isMobile || this.hideOnCollapse
                    ? index$1.iconClose
                    : this.expandIcon
                : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse)
                ? 'color-soft-text'
                : undefined, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": this.ariaLabelCollapseCloseButton }), index.h("div", { key: '7b0a88701252662ad99b0f2d133d4ac64a0259dd', class: {
                'title-text': true,
                rotate: rotate,
            } }, this.icon && (index.h("ix-icon", { key: 'd3b0c6002271434c710d3e2bf93fc7c6fb95f466', class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon })), index.h("div", { key: '971a85390b48c8259bdb5931fe89ebc61f2e14ca', class: "title-text-overflow" }, index.h("ix-typography", { key: '8e164a15a3176e56d1f43123f9fd4ac216af7abf', format: "h4" }, this.heading)), this.expanded && (index.h("div", { key: '85e105570a86dc944969aa9036eb5f332c51096d', class: "slot-header" }, index.h("slot", { key: '84b8c75d01ba8ae5b3a97e4bc6391fb5e3812f94', name: "header" }))))), index.h("div", { key: '3f6fe81218741df36010b2b0743dae4fba7ee729', class: "side-pane-content", hidden: !this.showContent }, index.h("slot", { key: '1b2c198261c7ec9f960a1be4773626408029c943' })))));
    }
