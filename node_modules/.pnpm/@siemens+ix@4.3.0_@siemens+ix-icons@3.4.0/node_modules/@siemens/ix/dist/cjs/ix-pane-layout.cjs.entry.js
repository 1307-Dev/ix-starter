...
const Panes = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9642eb5fb53b9843df4eb4c558cce46fb48d8c6e' }, !this.isMobile ? (this.layout == 'full-vertical' ? (index.h("div", { class: "side-panes-wrapper" }, index.h("div", { class: {
                row: true,
