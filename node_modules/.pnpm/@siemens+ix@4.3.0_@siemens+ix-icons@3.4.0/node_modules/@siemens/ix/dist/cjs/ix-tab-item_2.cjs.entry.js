...
var requestAnimationFrame$1 = require('./requestAnimationFrame-B0rWQ3G-.js');
...
const TabItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f0e6c03c7624e9d8ae86223da810ca909e89ceb9', class: this.tabItemClasses({
            ...
            } }, index.h("div", { key: '21b8861c7547865527d9395b1c288b358ca816c3', class: {
                circle: this.rounded,
                text: !this.rounded,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("slot", { key: '4e268ef6667abfd1e2b4ea85b7a34819a16c188a' })), index.h("div", { key: '86633194654d3ab97aaa0c37fdf22b9f2ea6dd7c', class: {
                counter: true,
                selected: this.selected,
...
const Tabs = class {
    ...
    renderArrows() {
        requestAnimationFrame$1.requestAnimationFrameNoNgZone(() => {
    ...
    render() {
        return (index.h(index.Host, { key: 'db27e336ea0432630306faa2e51f2799f1340d2c' }, this.showArrowPrevious && (index.h("button", { key: 'c9edd1bab0a829dd853a8dc227b59f068ea8b24a', class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, index.h("ix-icon", { key: '6271e2d4ccbc8d94793b0226c7117c8f1a24561a', name: index$1.iconChevronLeftSmall }))), index.h("div", { key: 'd1ff277b75c488f25821296fc5a7320f822f1bbd', class: {
                'tab-items': true,
            ...
            } }, index.h("div", { key: '9f929a8ba8f76c0efe8604218df1fe207eeff9ff', class: "items-content" }, index.h("slot", { key: 'a906661489fdee6484c871c7c7c46f0f1c5153fe' }))), this.showArrowNext && (index.h("button", { key: '632c5d16531fe4071368a94cdef569e43fd2ec71', class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, index.h("ix-icon", { key: '7105649d79c2a5a6d2c8fd3e6e9a0db540a61767', name: index$1.iconChevronRightSmall })))));
    }
