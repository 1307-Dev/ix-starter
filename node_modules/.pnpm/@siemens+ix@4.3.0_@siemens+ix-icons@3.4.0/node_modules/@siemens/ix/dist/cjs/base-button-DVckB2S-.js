...
const BaseButton = (props, children) => {
    ...
    const buttonContent = [
        ...
        props.icon && !props.loading ? (index.h("ix-icon", { class: "icon", name: props.icon, size: props.iconSize, color: props.iconColor, "aria-hidden": iconIsDecorative ? 'true' : undefined })) : null,
        index.h("div", { class: {
                content: true,
                [`content-${props.alignment}`]: !!props.alignment,
            } }, children),
        props.iconRight ? (index.h("ix-icon", { class: "icon-right", name: props.iconRight, size: props.iconSize, color: props.iconColor, "aria-hidden": iconIsDecorative ? 'true' : undefined })) : null,
...
//# sourceMappingURL=base-button-DVckB2S-.js.map
