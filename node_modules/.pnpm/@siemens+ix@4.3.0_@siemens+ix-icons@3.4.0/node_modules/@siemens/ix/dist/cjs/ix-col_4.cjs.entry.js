...
const DatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3a9fa36ed98d2dc14c9d0bf76f6fcdbc1595c8b2' }, index.h("ix-date-time-card", { key: 'd6da48a85d0c5cb1a6044c16d064782a3beed0c8', corners: this.corners, embedded: this.embedded }, index.h("div", { key: '56d86df8ea65f1bcdd988451ddbf276a62a8e52a', class: "header", slot: "header" }, index.h("ix-icon-button", { key: '1899225180b17d1d5d7aa50599f6af7b2c92a4df', onClick: () => this.changeToAdjacentMonth(-1), icon: index$1.iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), index.h("div", { key: 'cf4f3cf8d11665cabc959aad474aad833aa703f6', class: "selector" }, index.h("ix-button", { key: 'f1aa5c3e87ee65509298de13646a1fd1aaf62c72', variant: "tertiary", ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, index.h("span", { key: '8a1888092a6360c64b57f71eb52ace9ee1ed03d3', class: "capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), index.h("ix-dropdown", { key: '0922f29fe071cea744094e9553f38b35f113149c', "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start", enableTopLayer: this.enableTopLayer }, index.h("div", { key: 'e0f0df699dbafb2dbc5f00e03c5d5dc19e73f529', class: "wrapper" }, index.h("div", { key: 'f34845aec3de4ebf6dc07e869b57c57087ad6fb5', "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), index.h("div", { key: '519b8269d8f3a429fc1f5fdb8f2661f1cafa03b5', class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index$2) => (index.h("div", { key: month, ref: (ref) => {
                ...
                hidden: this.tempYear !== this.selectedYear ||
                    this.tempMonth !== index$2,
                checkPosition: true,
            }, name: index$1.iconSingleCheck, size: "16" }), index.h("div", null, index.h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`))))))))), index.h("ix-icon-button", { key: '0468474f772750fe7f96af5eb6129eeee5e52ee6', onClick: () => this.changeToAdjacentMonth(1), icon: index$1.iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), index.h("div", { key: '3b788560f65530ebb8faeb2c7e88d24b7f29bb08', class: {
                grid: true,
                'grid--show-week-numbers': this.showWeekNumbers,
            } }, this.showWeekNumbers && index.h("div", { key: '431517e6490f2fc715dad94b9d7719836df9514a', class: "calendar-item week-day" }), this.dayNames.map((name) => (index.h("div", { key: name, class: "calendar-item week-day" }, index.h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
        ...
        })), index.h("div", { key: 'd27a5261af7b95549a0d8956f2c267aea0d504fa', class: {
                button: true,
                hidden: this.singleSelection || this.embedded,
            } }, index.h("ix-button", { key: '629a9d41ba40bbc277ea41d1ec35f814949fe42a', onClick: () => this.onDone() }, this.i18nDone)))));
    }
...
const Row = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'edd5d38945ebc6f0b97cc6cf3ae0a9230f7dc2f2' }, index.h("slot", { key: 'd2556a5cc69da0d7fc5f0779e8453761d45a1de0' })));
    }
};
Row.style = rowCss;
