...
const DropdownHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6ec911ed6360d3e523a5a871007d874d67cf1334' }, index.h("ix-typography", { key: 'f1a8142ff1d8212a389649a6b7cc31495ccb9fa0', class: 'category-text', format: 'h5' }, this.label)));
    }
};
