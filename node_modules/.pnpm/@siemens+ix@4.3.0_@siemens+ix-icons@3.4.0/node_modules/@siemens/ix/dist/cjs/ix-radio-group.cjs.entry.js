...
const RadiobuttonGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7413f7b6787476e488a32908172af453c5d4766a', onIxBlur: () => (this.touched = true), ref: this.groupRef, role: "radiogroup" }, index.h("ix-field-wrapper", { key: 'f2c064b320a5dcf018eaf423394b7ab41c1937a0', label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, index.h("div", { key: '027e3c597249277c357e7c4d9f1fa38b44b33593', class: {
                'checkbox-container': true,
                'row-layout': this.direction === 'row',
            } }, index.h("slot", { key: '50ad290972cbb2dbcf5a7b7ea559fabc899ee295' })))));
    }
...
exports.ix_radio_group = RadiobuttonGroup;
//# sourceMappingURL=ix-radio-group.entry.cjs.js.map
