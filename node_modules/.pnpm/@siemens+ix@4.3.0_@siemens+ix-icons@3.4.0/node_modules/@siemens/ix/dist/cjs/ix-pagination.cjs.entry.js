...
var baseButton = require('./base-button-DVckB2S-.js');
...
const Pagination = class {
    ...
    render() {
        return (index.h(index.Host, { key: '87ceeea367a5c45d698729b11e63c95916ea386d' }, index.h("ix-icon-button", { key: 'ab5dceee67b569df139144b1a3576eddff120482', disabled: !this.count || this.selectedPage === 0, variant: "subtle-tertiary", icon: index$1.iconChevronLeftSmall, onClick: () => this.decrease(), "aria-label": this.ariaLabelChevronLeftIconButton }), this.advanced ? (index.h("div", { class: "advanced-pagination" }, index.h("ix-typography", { format: "body" }, this.i18nPage), index.h("input", { "aria-label": this.ariaLabelPageSelection, class: "ix-form-control page-selection", type: "number", min: "1", max: this.count, value: this.selectedPage + 1, onChange: (event) => {
            ...
            } }), index.h("span", { class: "total-count" }, index.h("ix-typography", { format: "body" }, this.i18nOf, " ", this.count)))) : (index.h("span", { class: "basic-pagination" }, this.renderPageButtons(), " ")), index.h("ix-icon-button", { key: '9429f00c69a19f6a7ef444511265345b5a821611', disabled: !this.count || this.selectedPage === this.count - 1, variant: "subtle-tertiary", icon: index$1.iconChevronRightSmall, onClick: () => this.increase(), "aria-label": this.ariaLabelChevronRightIconButton }), this.advanced && !this.hideItemCount && (index.h("span", { key: '137d49c4f064096f843767f5db6292895311c7df', class: "item-count" }, index.h("ix-typography", { key: '5c01577adf0e147a19459ac06933395490471aae', format: "body" }, this.i18nItems), index.h("ix-select", { key: '60be4defebb8df830bbf9d210e407c19e2e43820', hideListHeader: true, i18nPlaceholder: "", i18nSelectListHeader: "", value: `${this.itemCount}`, onValueChange: (e) => {
                const count = Number.parseInt(Array.isArray(e.detail) ? e.detail[0] : e.detail);
                this.itemCountChanged.emit(count);
            } }, index.h("ix-select-item", { key: '96db76852528700c3869f75f0d65144c54f2bb2e', label: "10", value: "10" }), index.h("ix-select-item", { key: '02168ff6e69abd6be997c8e9e35f4c08e68fc3e5', label: "15", value: "15" }), index.h("ix-select-item", { key: 'bb78749e12f32c2fdc87cca1455b7b087108c7e9', label: "20", value: "20" }), index.h("ix-select-item", { key: '6fe3a35cafc4a2f3a9abc434ff328e0f9dfbb59b', label: "40", value: "40" }), index.h("ix-select-item", { key: '4ebef54b0980ad0a2336b99702e0e82d92bfcb1c', label: "100", value: "100" }))))));
    }
