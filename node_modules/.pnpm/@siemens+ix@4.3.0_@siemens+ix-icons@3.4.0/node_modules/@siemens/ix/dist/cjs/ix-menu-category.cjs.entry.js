...
const MenuCategory = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'edd1e65e5cd1cc96d1da1decfa666654d3926f6d', class: {
            ...
            } }, index.h("ix-menu-item", { key: 'bd7b6f2c2bef925249db2b73ad14e1454a291939', class: 'category-parent', active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onFocus: () => this.onPointerEnter(), tooltipText: this.tooltipText, isCategory: true }, index.h("div", { key: '1bdd93be15ca3e24d491ce54aed4e441617bdbaf', class: "category" }, index.h("div", { key: '37444ebec527ba83b30675b3c01411770989f77b', class: "category-text" }, this.label), index.h("ix-icon", { key: '3e3967c7973058113c32f4f90a9343079bfc4d52', name: index$1.iconChevronDownSmall, class: {
                'category-chevron': true,
                'category-chevron--open': this.showItems,
            }, "aria-hidden": "true" }))), index.h("div", { key: '270aa92509cdf90771863199a9483d5039289d94', ref: (ref) => (this.menuItemsContainer = ref), class: {
                'menu-items': true,
                'menu-items--expanded': this.showItems,
                'menu-items--collapsed': !this.showItems,
            } }, this.showItems ? index.h("slot", null) : null), index.h("ix-dropdown", { key: 'f81b8c80a0bef8cec723260df27c01ed0299a4d4', closeBehavior: 'both', show: this.showDropdown, onShowChanged: ({ detail: dropdownShown }) => {
            ...
            } }, index.h("ix-dropdown-item", { key: '88b93b5ac540e470b659e0fa0e2a788cf9da0b3d', class: 'category-dropdown-header' }, index.h("ix-typography", { key: '2664b30d7a7aa21de7dd6874a8f8471bcb5f0dee', format: "label", bold: true, textColor: "std" }, this.label)), index.h("ix-divider", { key: 'af94566fdd4ad843ce75332b8e511201bfad790c' }), index.h("slot", { key: '735e220778d5ac78309c4133d11a1b8fad67431e' }))));
    }
