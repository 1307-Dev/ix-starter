import { r as registerInstance, h, H as Host } from './index-97874de0.js';
...
const IxLinkButtonStyle0 = linkButtonCss;
...
const LinkButton = class {
    ...
    render() {
        return (h(Host, { key: 'e3419b23a7cf8cfb5f686098ea48148750f95ec3' }, h("a", { key: 'd7c083c55985791d3a49f854537d5b89b270b44c', title: this.url, tabindex: "0", class: {
                'link-button': true,
                disabled: this.disabled,
            }, href: this.disabled ? undefined : this.url, target: this.target }, h("ix-icon", { key: '1b08e1a5b8a119d665e1fe001b0c3c92e1bd4874', class: "icon", name: 'chevron-right-small', size: "16" }), h("div", { key: '9cb9f475670cb4993ac27ea3383f5f28210766f3', class: {
                link: true,
                disabled: this.disabled,
            } }, h("slot", { key: '866e85c5c6336d9eb17ec452aaa25e85bfb94018' })))));
    }
};
