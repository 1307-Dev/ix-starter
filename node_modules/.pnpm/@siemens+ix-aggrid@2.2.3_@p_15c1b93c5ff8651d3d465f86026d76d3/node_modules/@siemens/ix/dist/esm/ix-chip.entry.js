...
const Chip = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8828e86173edb2fd394b6ef3f3ad72e6f195357d', tabIndex: "-1", title: this.hostElement.textContent, style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': (_b = this.chipColor) !== null && _b !== void 0 ? _b : this.color,
                }
                : {} }, h("div", { key: '4260ced6a9b756468acb9806474c2035b98e9dcc', style: Object.assign({}, customStyle), class: {
                container: true,
                ...
                icon: !!this.icon,
            } }, h("ix-icon", { key: '561bdadfa0eda55b25ac61788417fd7545652d46', class: {
                'with-icon': true,
                hidden: !this.icon,
            }, name: this.icon, size: '24' }), h("span", { key: '6b4454a2e6bd160923c89382c8da334e27f6f2df', class: "slot-container" }, h("slot", { key: 'a18be9b41aa18f17343586fed0e4f31bbe1037c5' })), isInactive === false && this.closable ? this.getCloseButton() : null)));
    }
