...
import { H as HookValidationLifecycle } from './validation-54137eaa.js';
...
const Checkbox = class {
    ...
    render() {
        return (h(Host, { key: '9f2dfb28e104211b4c74190ce34782e927c359be', "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
                disabled: this.disabled,
                checked: this.checked,
                indeterminate: this.indeterminate,
            } }, h("label", { key: 'f5e2ae66239974ec5f91c1898b3c82a8efc06178' }, h("input", { key: '465622f5215ebb9bf62f7d6a44adfd55dbeb251a', "aria-checked": a11yBoolean(this.checked), disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("button", { key: '3e16d5cb70ecdb1c46f3ec05d87708dce31cc32a', disabled: this.disabled, class: {
                checked: this.checked,
            }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), h("ix-typography", { key: 'a525f43a85e83bb23ddb204afa2b5600a0441c2d', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, h("slot", { key: '531c5b1a6bb0748e59e378c898de733cc13da0c5' })))));
    }
