...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e3dac43f6f2e9cde6a6d639cb3bcebeb9e9b411', class: {
                visible: this.modalVisible,
                'no-backdrop': this.backdrop === false,
                'align-center': this.centered,
            } }, index.h("div", { key: '5ea3cf91488446be08e7fc4802b3e167fc688437', class: "dialog-backdrop" }, index.h("dialog", { key: 'a298c12b344b74ea11a4ba9749a18b49ba97f697', "aria-modal": a11y.a11yBoolean(true), "aria-describedby": this.ariaAttributes['aria-describedby'], "aria-labelledby": this.ariaAttributes['aria-labelledby'], class: {
                modal: true,
                [`modal-size-${this.size}`]: true,
            }, onClose: () => this.dismissModal(), onClick: (event) => this.onModalClick(event), onCancel: (e) => {
                e.preventDefault();
                this.dismissModal();
            } }, index.h("slot", { key: 'a1da640bda6f15e9c48eb5b3b3f7e336c99cb85b' })))));
    }
