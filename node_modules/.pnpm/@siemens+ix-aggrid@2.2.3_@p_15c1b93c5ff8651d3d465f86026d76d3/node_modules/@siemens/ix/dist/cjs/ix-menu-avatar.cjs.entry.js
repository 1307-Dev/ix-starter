...
const MenuAvatar = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f3761a16d1ebc179e8c7a604182efeebc3ae5dbe', slot: "ix-menu-avatar" }, index.h("button", { key: '706ec6cdd7eb3f45cb6c8cd901511f3bb133d7e7', class: "nav-item top-item avatar no-hover", title: this.top, id: this.avatarElementId, tabIndex: 0 }, index.h("ix-avatar", { key: 'b1ace48f1f21901639d89445ae1e5260772a47e1', image: this.image, initials: this.initials }), index.h("div", { key: 'e6f0edea42cf5c6de4eefa716c1573b1f42133c6', class: "avatar-name" }, index.h("span", { key: '99532083258dbe7a1a4f6bf304c314c25b4f3339', class: "text-default-single", title: this.top }, this.top), index.h("span", { key: '7ba1b282e56f2e6767da4347ec42e501ec0347cd', class: "text-default-single", title: this.bottom }, this.bottom))), index.h("ix-dropdown", { key: 'a38543969a094859633a7c3979f5262a0bbc8611', trigger: this.hostElement, placement: 'right-start', hidden: !this.showContextMenu && !this.showLogoutButton, offset: {
                mainAxis: 16,
            } }, index.h("slot", { key: 'a6c20075e5beaa33e197889ea41f585e7f079719', onSlotchange: () => this.onSlotChange() }), this.showLogoutButton ? (index.h("ix-menu-avatar-item", { label: this.i18nLogout, icon: 'log-out', onClick: (e) => {
