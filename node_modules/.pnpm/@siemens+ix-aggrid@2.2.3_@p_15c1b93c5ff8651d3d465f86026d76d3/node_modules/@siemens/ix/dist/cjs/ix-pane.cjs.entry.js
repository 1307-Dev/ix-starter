...
const Pane = class {
    ...
    render() {
        return (index.h(index.Host, { key: '10816a88c5f350682564704c5412edb412a793ee', class: {
            ...
            } }, index.h("aside", { key: 'e9a81d713d0d1b6197615224664f1f4c3b739d3f', id: `pane-${this.composition}`, class: {
                'top-bottom-pane': this.isBottomTopPane && !this.isMobile,
                'left-right-pane': this.isLeftRightPane && !this.isMobile,
                'mobile-pane': this.isMobile,
                expanded: this.expanded,
            } }, index.h("div", { key: '650b4d96a644d8e27df9b9b9a9bbece1a596c978', id: "title-div", class: {
            ...
            } }, index.h("ix-icon-button", { key: '3639fe948bf9c943eb9589bcad8721a9961d040e', class: "title-icon", size: "24", icon: this.expanded
                ? this.isMobile || this.hideOnCollapse
                    ? 'close'
                    : this.expandIcon
                : this.minimizeIcon, ghost: true, onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}` }), index.h("span", { key: 'b53ab16718c7b3c700d2afd50d06893c0b67045c', class: {
                'title-text': true,
                rotate: !this.expanded && !this.isMobile && this.isLeftRightPane,
            } }, this.icon ? (index.h("ix-icon", { size: "24", name: this.icon })) : null, index.h("div", { key: '0f00dc68707c7fda5b3d405b60a37effb27745aa', class: "title-text-overflow" }, index.h("ix-typography", { key: '74f167541755b2c139dd871443568f55e6938607', format: "h4" }, this.heading)))), index.h("div", { key: '699126620ea3bb6687720bc7881cb7cdb927c47e', class: "side-pane-content", hidden: !this.showContent }, index.h("slot", { key: '1661dc8a64c4898de6e0960e5c5771a05b0f5ec1' })))));
    }
