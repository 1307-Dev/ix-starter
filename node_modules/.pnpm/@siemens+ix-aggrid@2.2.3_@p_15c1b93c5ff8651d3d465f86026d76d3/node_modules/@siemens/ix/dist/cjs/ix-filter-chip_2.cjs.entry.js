...
const FilterChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e2bd061568d76abd274b622bbee0ebe564ef3b62', class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, index.h("div", { key: '95fcf42b92653882a9dfbc8fc221b46aeaef07b5', class: "slot-container" }, index.h("slot", { key: '6d8fc76fcae0910c59aa58a9147c1b625635b5e0' })), !this.disabled && !this.readonly ? (index.h("ix-icon-button", { ghost: true, oval: true, icon: 'close-small', size: "16", tabindex: this.disabled ? -1 : 0, variant: "primary", disabled: this.disabled, onClick: (e) => this.onCloseClick(e) })) : null));
    }
...
const SelectItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c7dccaf344ac8c8fd48160ab8a476b940d274865' }, index.h("ix-dropdown-item", { key: '8951264f99fed7430b8e8dab90d8ec2c6b7d64db', class: {
