...
const MapNavigationOverlay = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: 'a4a9212346318b008cfcee34c836ebe3b76b3736' }, index.h("div", { key: '53f16eaa2cd54107e464ea2abf02bb1b34b4e38e', class: "overlay-header" }, index.h("div", { key: '849d8b21d699a77415950602a94c222b5f6cd7ea', class: {
                ...
                'background-color': ((_b = this.iconColor) !== null && _b !== void 0 ? _b : this.color)
                    ...
                    : '',
            } }), index.h("div", { key: '98b44112dad6abb6b67bc26971162744f88478b0', class: "overlay-header-content" }, index.h("ix-icon", { key: '50d1bf17ba70f3556205a08286a6a5b9387f7565', size: "32", name: this.icon }), index.h("span", { key: 'a11a97f11f0026f9c951b41a0aac450012fa68f3', class: "overlay-header-title", title: this.name }, this.name)), index.h("ix-icon-button", { key: 'd7c015eff6d28d68c86b02e66c34affd32fd3bf6', class: "overlay-close", ghost: true, icon: 'close', size: "24", onClick: () => this.closeOverlay() })), index.h("slot", { key: '306cd8aeaa073ea2e643e47dc53af770d51d75f2' })));
    }
