...
const MenuAboutNews = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f049e1713ce75c3cf0a066dbcd3878c5752d63b8', class: {
                expanded: this.expanded,
                show: !this.show,
            } }, index.h("div", { key: '23f5331fd81c1ac67f36a3f7c2eb0e408f1517a5', class: "banner-container" }, index.h("ix-icon", { key: 'b2b6cc51da89551b5e9ec4f31b026202cb3370a4', color: "color-inv-contrast-text", name: 'shout', size: "32" }), index.h("svg", { key: '2c5b9496a40c3e96af0e12e5f647bac4975060d4', viewBox: "0 0 48 56", xmlns: "http://www.w3.org/2000/svg" }, index.h("polygon", { key: 'ad6a493b513524ed82fb78ad5c9a912c394ac068', points: "0 0 48 0 48 56 24 48 0 56" }))), index.h("div", { key: '6c9ae33a65929aaa7da29f91727f298e7ed7ae92', class: "cui-popover-news-header" }, index.h("ix-typography", { key: 'b8e0d8e7b8c2087a0ac5b787db60074fc482cd0e', format: "label", bold: true }, this.label)), index.h("ix-icon-button", { key: '92b7e27a53e227688f8794d6dffa451453f3416f', size: "24", icon: 'close', ghost: true, onClick: () => {
                this.show = false;
                this.closePopover.emit();
            } }), index.h("div", { key: 'eb0cdf640a458dcf0f98563402cd1ccd4e111a43', class: "slot-container" }, index.h("slot", { key: 'f59b5a5825a4daa8b2026e3385b22198c0a893b2' })), this.aboutItemLabel ? (index.h("div", { class: "cui-popover-news-footer" }, index.h("ix-button", { variant: "primary", onClick: (e) => {
                this.show = false;
                this.showMore.emit(e);
            } }, this.i18nShowMore))) : null, index.h("div", { key: '227e365fa14960bd5f01a54eef9434260cac4055', id: "arrow" })));
    }
};
