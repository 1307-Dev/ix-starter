...
const NumberInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a0f7f1e42f50080a3c68ed8a46415653d8c98db1', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: 'e63d9ee61378d6d25b80f2d8aefa3f572e3a183d', id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: '31b3a31fff69a0b93c652760acef0d555feb0ae9', class: {
                'input-wrapper': true,
                'show-stepper-buttons': !!this.showStepperButtons,
            } }, index.h(input_util.SlotStart, { key: 'edb32763f14d9b11605e17cbc16464137eb1ed6a', slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h(input_util.InputElement, { key: 'c48f472ed7f054065b73451bcde40b5e5e02327d', id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, pattern: this.pattern, type: 'number', isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => input_util.checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(Number(value)), updateFormInternalValue: (value) => this.updateFormInternalValue(Number(value)), onBlur: () => input_util.onInputBlur(this, this.inputRef.current) }), index.h(input_util.SlotEnd, { key: 'd5ee594714f6c90c1bf26938713945f0f809d289', slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("div", { key: '6ac348b7205923bf4063cd58b76a16b6dca456db', class: {
                'number-stepper-container': true,
                'container-hidden': !showStepperButtons,
            } }, index.h("ix-icon-button", { key: 'e2e59a1ee82aefb45d330f9ad5a7a74dc86b5fe8', ghost: true, icon: index$1.iconMinus, size: "16", class: "number-stepper-button step-minus", onClick: () => {
            ...
            } }), index.h("ix-icon-button", { key: '4e7ed976d0248efa798c304b40c85607714c32d7', ghost: true, icon: index$1.iconPlus, size: "16", class: "number-stepper-button step-plus", onClick: () => {
                if (!this.inputRef.current) {
                    return;
                }
