...
const MessageBar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '94f3ffb15597b45ecc76e5914f13550c4d882288' }, index.h("div", { key: 'eaa19cbf27288f4a752b7cbf61b7c33319f2c1d7', class: { 'message-container': true, [this.type]: true }, role: "alert", ref: (el) => (this.divElement = el) }, index.h("ix-icon", { key: 'cbced877ee67adf695b59de394a085fae3c43e41', color: this.color, name: this.icon }), index.h("div", { key: '610ca0dbb5c9c3e0e5099b58a1f449c07a4bc120', class: "message-content" }, index.h("slot", { key: 'c9f13ca7096ba9694ff112a704958082281fa783' })), this.dismissible ? (index.h("ix-icon-button", { icon: 'close', size: "24", ghost: true, onClick: () => {
                if (this.divElement) {
