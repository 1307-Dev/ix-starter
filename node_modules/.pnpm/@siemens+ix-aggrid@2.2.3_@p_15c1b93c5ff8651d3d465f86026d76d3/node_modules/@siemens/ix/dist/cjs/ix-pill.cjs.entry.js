...
const Pill = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cf932b24a24c809c20ea8bc85cc71c6b2202c975', style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': (_b = this.pillColor) !== null && _b !== void 0 ? _b : this.color,
                }
                : {}, title: this.hostElement.textContent, class: {
                'align-left': this.alignLeft,
            } }, index.h("div", { key: '362019713872b5b86e0652ec6abaf839601812e0', style: Object.assign({}, customStyle), class: {
                container: true,
            ...
            } }, index.h("ix-icon", { key: '1373ff2c8bdc7efb83c4b29f6ee33aec624f408d', class: {
                'with-icon': true,
                hidden: this.icon === undefined || this.icon === '',
            }, name: this.icon, size: '16' }), index.h("span", { key: '29b1e6315c5a2a65c0c9fc35b86ead8e7f69bfe7', class: "slot-container" }, index.h("slot", { key: 'a43419e4efbdcdf54318fb261c1db932c1e08d92', onSlotchange: () => this.checkIfContentAvailable() })))));
    }
