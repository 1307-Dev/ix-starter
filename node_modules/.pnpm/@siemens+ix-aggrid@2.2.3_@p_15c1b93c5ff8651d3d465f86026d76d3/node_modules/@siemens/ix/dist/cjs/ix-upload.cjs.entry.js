...
const Upload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: '3a55e79e4811a751f14647902d8c1c282211c26e' }, a11y, { "aria-disabled": disabled }), index.h("div", { key: '82ac8595fbb714efcb3cb580ce14c20079076151', class: {
            ...
            }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), index.h("div", { key: '10a744ae27d99947d1f3bf45149c596e78d50490' }, index.h("input", { key: '2ec73592d331cc04ab37a587d450de8d80aa2c1f', "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", onChange: (e) => {
                this.fileChangeEvent(e);
            }, accept: this.accept, disabled: disabled }), index.h("ix-button", { key: '4129829189afc794863da9271db0d4d5f2564e4e', tabindex: "-1", outline: true, onClick: () => this.inputElement.click(), disabled: disabled }, this.i18nUploadFile)))));
    }
