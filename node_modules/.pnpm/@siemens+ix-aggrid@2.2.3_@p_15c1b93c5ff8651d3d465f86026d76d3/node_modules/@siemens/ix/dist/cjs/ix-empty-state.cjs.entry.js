...
const EmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cb312e54bc903b7f3d59faed9850e9500847869e', class: `emptyState emptyState--${this.layout}` }, this.icon && (index.h("div", { key: 'c901252f66e6f97ef42808c1e881bac76b40674a', class: "emptyState__icon" }, index.h("ix-icon", { key: '1ee24a795580830a364f8b541b94e230d7797365', name: this.icon, size: this.layout === 'large' ? '32' : '32', color: "color-soft-text" }))), index.h("div", { key: 'ab641cce5937da8014ec76af23349dd629575a2e', class: "emptyState__content" }, index.h("div", { key: '8d6340d04768a47ccd1333d628342bb894d7387a', class: "content__label" }, index.h("ix-typography", { key: 'f27adb6c7a93e36117022dd2294b46a34b0f4c79', format: this.layout === 'large' ? 'h3' : 'body' }, this.header), this.subHeader && (index.h("div", { key: 'ca49901be387ce044c5aa6da90fab8d8f2dc06a1', class: "label__subHeader" }, this.subHeader))), this.action && (index.h("div", { key: '76755b670cae1926e6d976244a81f1b3c9eca76b', class: "content__action" }, index.h("ix-button", { key: '937d705608063a0e586d112f7c848883abd361fb', onClick: () => this.actionClick.emit() }, this.action))))));
    }
};
