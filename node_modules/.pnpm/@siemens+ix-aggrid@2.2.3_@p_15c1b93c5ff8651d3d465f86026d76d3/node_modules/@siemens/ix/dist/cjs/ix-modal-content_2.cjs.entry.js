...
const ModalContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '84ebcbda08133eb94f2f5b60abb2b2b7bb5ab37a' }, index.h("slot", { key: '6c1fd9c108911fd724794555d9a0d47d951384c2' })));
    }
};
...
const ModalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a1f7e00b9cd9f848fca485129d59ebfabecaee76' }, this.icon ? (index.h("ix-icon", { name: this.icon, color: this.iconColor, size: "32" })) : null, index.h("div", { key: '35e8529a8b4f5a7c934210a2ec7b86af9d4b5adc', class: "modal-title" }, index.h("ix-typography", { key: '624ca4d302a98fb86dda4356fd8e9936eadb4e5b', format: "h5" }, index.h("slot", { key: '8145c7dbcfafe35d9bd715aaaf671f579f298449' }))), !this.hideClose ? (index.h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), ghost: true, icon: "close" })) : null));
    }
