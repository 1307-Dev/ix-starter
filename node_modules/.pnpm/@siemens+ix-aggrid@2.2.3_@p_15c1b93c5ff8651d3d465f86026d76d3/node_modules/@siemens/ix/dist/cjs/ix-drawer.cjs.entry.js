...
const Drawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ac728baf67cce06aa8c7e32d94260bb19f3ae975', class: {
            ...
            }, ref: (el) => (this.divElement = el), "data-testid": "container", id: "div-container" }, index.h("div", { key: '6e231cce941e71ef047928887a33adb0132d8445', class: "header" }, index.h("div", { key: 'f2402cca887c5e7fa9683238c88c7897b8ea44aa', class: "header-content" }, index.h("slot", { key: '53094fefd525653955888a23319c647bc0a3417e', name: "header" })), index.h("ix-icon-button", { key: '14ec5affe35d226ddc9d9a680aa6f0311283ff67', class: "close-button", icon: 'close', size: "24", ghost: true, onClick: () => this.onCloseClicked(), "data-testid": "close-button" })), index.h("div", { key: 'd745b2cf4231cca34751c60e9694fc285cfd84a3', class: "content" }, index.h("slot", { key: '1137f322e50760060a0b468ceae8fdcc8078d1f2' }))));
    }
