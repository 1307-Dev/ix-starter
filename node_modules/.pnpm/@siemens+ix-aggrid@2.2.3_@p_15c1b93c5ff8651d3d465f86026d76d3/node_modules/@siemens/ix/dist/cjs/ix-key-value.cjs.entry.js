...
const KeyValue = class {
    ...
    render() {
        return (index.h(index.Host, { key: '195f88cef96aedc49ec5810b7474cfce3454aba2', class: `keyValue keyValue--${this.labelPosition === 'top' ? 'column' : 'row'}` }, this.icon && (index.h("ix-icon", { key: '561114ef9e34f47d35dd9dc484fade62c9e8a408', name: this.icon, size: "24", class: "keyValue__icon" })), index.h("div", { key: 'e747dbd0b15a3e8f93aea4503b99311c8473a703', class: "keyValue__content" }, index.h("div", { key: '6d8374a50acc00de0373b7c37766f7ca7bd68161', class: "content__label" }, this.label), index.h("div", { key: '1744e77f960a9720e42a7756b5a12cf24b127a02', class: {
                content__value: true,
