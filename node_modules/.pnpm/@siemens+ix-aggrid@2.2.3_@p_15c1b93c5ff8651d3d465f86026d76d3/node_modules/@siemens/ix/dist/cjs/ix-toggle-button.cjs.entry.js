...
const ToggleButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6e4c00d9254141696c832a3102fb02615af91c62', class: {
                disabled: this.disabled || this.loading,
            } }, index.h(baseButton.BaseButton, Object.assign({ key: '60ccac36e5c7f72ca72ad06ba685eacca7fb6c34' }, baseButtonProps), index.h("slot", { key: 'fe9a17c7cb02ada4a100aaf2cbc4e8390fecc7b9' }))));
    }
