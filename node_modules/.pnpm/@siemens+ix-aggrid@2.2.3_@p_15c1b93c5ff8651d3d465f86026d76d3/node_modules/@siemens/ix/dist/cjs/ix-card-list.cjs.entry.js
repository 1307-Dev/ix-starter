...
function CardListTitle(props) {
    ...
    return (index.h("div", { class: "CardList_Title" }, index.h("ix-icon-button", { ghost: true, icon: 'chevron-down', onClick: props.onClick, color: "color-primary", class: {
        ...
        } }), index.h("ix-typography", { class: "CardList_Title__Label", format: "body-lg" }, props.label), !props.hideShowAll && (index.h("ix-button", { class: "CardList__Title__Show__All", ghost: true, onClick: props.onShowAllClick }, index.h("span", null, props.showAllLabel), index.h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)))));
}
const CardList = class {
    ...
    render() {
        return (index.h(index.Host, { key: '317a088e7cf0ac2ff01d46fabe293b6dafa55d49' }, index.h(CardListTitle, { key: '1eb6e1e6c43432737bd9d1718c89539ae9dce42b', isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === undefined
                ? this.numberOfAllChildElements
                : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), index.h("div", { key: '0c47be401efa5bd5dec00ad948b15d9d46a1a29f', class: {
                CardList__Overflow: true,
            }, style: this.computeMaskLayer() }, index.h("div", { key: '32cd8526bf44cef7249b08c8fc68d446ff6962af', class: {
            ...
            }, onScroll: () => this.onCardListScroll() }, index.h("slot", { key: 'a75fd0e0d1a4abd96d00db8bbbe78cc4f9b1c100', onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? (index.h("ix-card", { class: {
                Show__All__Card: true,
            }, onClick: (event) => this.showMoreCardClick.emit({
                nativeEvent: event,
            }) }, index.h("ix-card-content", null, index.h("div", { class: "Show__All__Card__Content" }, index.h("ix-icon", { name: 'more-menu', size: '32', class: 'Show__All__Card__Icon' }), index.h("span", { class: "Show__All__Card__Text" }, this.i18nMoreCards, " (", this.numberOfOverflowingElements, ")"))))) : null))));
    }
