...
const baseIconButton = require('./base-icon-button-d09d934e.js');
const a11y = require('./a11y-ae470f01.js');
require('./base-button-119d9368.js');
...
const IconButton = class {
    ...
    render() {
        ...
        const baseButtonProps = {
            ariaAttributes: {
                'aria-label': this.a11yLabel
                    ? this.a11yLabel
                    : a11y.getFallbackLabelFromIconName(this.icon),
            },
        ...
        return (index.h(index.Host, { key: '3091c9758d6693c028e1cdc757bbf7e4daf7be3d', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, index.h(baseIconButton.BaseIconButton, Object.assign({ key: '9cdb02f93735e8a2eb0a165bd6459d3e2b4b11d9' }, baseButtonProps))));
    }
    get hostElement() { return index.getElement(this); }
};
IconButton.style = IxIconButtonStyle0;
...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c83cb66db02c37e6c6039d0b52c78abb59112f3a' }, index.h("div", { key: '7d7179876635f26061798546fc1cf45f1311fba5', class: {
