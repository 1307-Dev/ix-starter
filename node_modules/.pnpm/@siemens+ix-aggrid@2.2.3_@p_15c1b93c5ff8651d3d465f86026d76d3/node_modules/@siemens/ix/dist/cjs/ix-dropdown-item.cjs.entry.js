...
const DropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7b2135346336a1240640cc084f98ebeac8ac5828', class: {
                hover: this.hover,
                'icon-only': this.isIconOnly(),
                disabled: this.disabled,
                submenu: this.isSubMenu,
            }, role: "listitem" }, index.h("button", { key: 'ec9ff70fcfbea969ebfe133575585f970f4caa98', type: "button", tabIndex: 0, class: {
                'dropdown-item': true,
                'no-checked-field': this.suppressChecked,
            }, onClick: () => this.emitItemClick() }, !this.suppressChecked ? (index.h("div", { class: "dropdown-item-checked" }, this.checked ? (index.h("ix-icon", { class: "checkmark", name: 'single-check', size: "16" })) : null)) : null, this.icon ? (index.h("ix-icon", { class: "dropdown-item-icon", name: this.icon })) : null, index.h("div", { key: '582689eb920e8e79f285ba9cdb8d70920b5ae589', class: "dropdown-item-text" }, this.label, index.h("slot", { key: 'bda7606e512795bc30fafa31bd824aa3e29ecbf8' })), this.isSubMenu ? (index.h("ix-icon", { name: 'chevron-right-small', class: 'submenu-icon' })) : null)));
    }
