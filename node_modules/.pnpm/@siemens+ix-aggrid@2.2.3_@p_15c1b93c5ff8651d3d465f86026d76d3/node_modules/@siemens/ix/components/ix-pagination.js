...
import { d as defineCustomElement$c } from './dropdown.js';
import { d as defineCustomElement$b } from './dropdown-item.js';
import { d as defineCustomElement$a } from './field-label.js';
import { d as defineCustomElement$9 } from './field-wrapper.js';
import { d as defineCustomElement$8 } from './filter-chip.js';
import { d as defineCustomElement$7 } from './icon-button.js';
import { d as defineCustomElement$6 } from './select.js';
import { d as defineCustomElement$5 } from './select-item.js';
...
const Pagination = /*@__PURE__*/ proxyCustomElement(class Pagination extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '8f28dce6f49cf4b71ac337d5b721b6a10091999a' }, h("ix-icon-button", { key: '838b447430b77ba147efe3721340a2a425f31f2c', disabled: !this.count || this.selectedPage === 0, ghost: true, icon: 'chevron-left-small', onClick: () => this.decrease() }), this.advanced ? (h("div", { class: "advanced-pagination" }, h("ix-typography", { format: "body" }, this.i18nPage), h("input", { class: "form-control page-selection", type: "number", min: "1", max: this.count, value: this.selectedPage + 1, onChange: (event) => {
                const eventTarget = event.target;
                if (eventTarget) {
                    const index = Number.parseInt(eventTarget.value);
                    this.selectPage(index - 1);
                }
            } }), h("span", { class: "total-count" }, h("ix-typography", { format: "body" }, this.i18nOf, " ", this.count)))) : (h("span", { class: "basic-pagination" }, this.renderPageButtons(), " ")), h("ix-icon-button", { key: 'efcf14835418f853d90ba459372253ab213bf48d', disabled: !this.count || this.selectedPage === this.count - 1, ghost: true, icon: 'chevron-right-small', onClick: () => this.increase() }), this.advanced && this.showItemCount ? (h("span", { class: "item-count" }, h("ix-typography", { format: "body" }, this.i18nItems), h("ix-select", { hideListHeader: true, i18nPlaceholder: "", i18nSelectListHeader: "", value: `${this.itemCount}`, onValueChange: (e) => {
