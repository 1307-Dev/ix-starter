...
const ValidationTooltip = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'fce95b6a9df85da12c742a92ae5af48c15f5a04b' }, index.h("slot", { key: 'c70130b23d312a884677e0aea4cf54158ebb36e4' }), index.h("div", { key: '551b30175043178ead3068637b7525fcf2378623', role: "tooltip", style: {
                display: 'none',
                position: 'fixed',
                top: '0',
                left: '0',
            ...
            }, class: "validation-tooltip text-default" }, this.message, index.h("slot", { key: 'f9af434ac0ae7710dccca7ffc6fb6a6b71546fc3', name: "tooltip-message" }), index.h("div", { key: '66da811f499a7a995149e3575ef95b8eb5eac8e7', id: "arrow" }))));
    }
