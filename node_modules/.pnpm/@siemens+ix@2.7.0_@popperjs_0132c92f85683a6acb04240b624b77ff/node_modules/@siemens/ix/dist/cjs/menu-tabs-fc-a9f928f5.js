...
const MenuSettings = class {
    ...
    render() {
        return index.h(MenuTabs, { key: 'e5a0d1cc238a2c88d9a0c572fbfecefd3a589c38', context: this });
    }
...
const getTabItems = (context) => {
    return context.items.map(({ label }) => {
        return (index.h("ix-tab-item", { selected: label === context.activeTabLabel, onClick: () => {
                if (label) {
...
//# sourceMappingURL=menu-tabs-fc-a9f928f5.js.map