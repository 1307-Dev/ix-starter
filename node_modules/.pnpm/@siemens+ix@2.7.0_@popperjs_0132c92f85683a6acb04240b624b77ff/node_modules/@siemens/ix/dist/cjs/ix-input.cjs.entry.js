...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6d40be91cda9c61dacb10c47cb3c1de128b595c', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: 'e920830918a1b52ae71373c6b09460282840d996', htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: '683a76fa9cf8bdb266d202b3d2977415f7940374', class: "input-wrapper" }, index.h(input_util.SlotStart, { key: '93835b09dd2c87cf4c027afdf8b2e5ac54446ce6', slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h(input_util.InputElement, { key: '9d75e41be3064ed775dc6adea268681d33d4114b', id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => input_util.checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => input_util.onInputBlur(this, this.inputRef.current), ariaAttributes: inputAria }), index.h(input_util.SlotEnd, { key: 'edc365019e67448855bd73f2fd6324e6b0784e80', slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("ix-icon-button", { key: '22075d37959ab4d9a45e8792c62b0595e02d23d9', color: "color-weak-text", class: {
                'password-eye': true,
            ...
            } }))), !!this.maxLength && this.maxLength > 0 && (index.h("ix-typography", { key: '4b2dab4589a0191a9097db3075e1e10dfcab3476', class: "bottom-text", slot: "bottom-right", color: "soft" }, (_a = this.value) === null || _a === void 0 ? void 0 :
...
Input.style = IxInputStyle0;

exports.ix_input = Input;

//# sourceMappingURL=ix-input.cjs.entry.js.map