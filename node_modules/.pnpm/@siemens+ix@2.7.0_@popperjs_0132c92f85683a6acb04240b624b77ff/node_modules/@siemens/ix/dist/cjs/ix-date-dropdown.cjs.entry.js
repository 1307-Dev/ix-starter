...
const DateDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b4d969756a441b41db705ed2e0e3c869923df58a' }, index.h("ix-button", { key: 'aa79503137737514e6c3ff00a89beebdc6020600', "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, ghost: this.ghost, outline: this.outline, loading: this.loading, icon: "history", ref: this.triggerRef, disabled: this.disabled }, this.getButtonLabel()), index.h("ix-dropdown", { key: 'e812b148194e5c0d28137b1f9acae0be678c37da', "data-testid": "date-dropdown", "data-date-dropdown": true, class: "min-width max-height", trigger: this.triggerRef.waitForCurrent(), closeBehavior: "outside", placement: "bottom-start", onShowChanged: ({ detail: show }) => {
            ...
            } }, index.h("ix-layout-grid", { key: 'bd671f13b233e9286a707895622c77350b54f993', "no-margin": "true" }, index.h("ix-row", { key: 'f4f88f2b7c70afc88968aa3ccaf635dc5d011c09' }, ((_a = this.dateRangeOptions) === null || _a === void 0 ? void 0 : _a.length) > 1 && (index.h("ix-col", { key: '4509fe366560787efcef157279900475640a7d1c', class: {
                'no-margin': true,
                'border-right': this.selectedDateRangeId === 'custom',
            } }, this.dateRangeOptions.map((dateRangeOption) => (index.h("ix-dropdown-item", { label: dateRangeOption.label, onClick: () => this.onRangeListSelect(dateRangeOption.id), checked: this.selectedDateRangeId === dateRangeOption.id }))), index.h("div", { key: '25ebfe04bab64152ce9c901a7899e95964891b8a', hidden: !this.customRangeAllowed }, index.h("ix-dropdown-item", { key: '9ea2297749b7c20743e592129e3c03a6c96ae3dc', label: this.i18nCustomItem, checked: this.selectedDateRangeId === 'custom', onClick: () => this.onRangeListSelect('custom') })))), index.h("ix-col", { key: 'de1b089479091b6daf75a3c575dbfc14b378b808', class: "no-margin" }, this.selectedDateRangeId === 'custom' && (index.h(index.Fragment, { key: 'ff476d3ea38df74580130098b3ae1a46b2e4f99c' }, index.h("ix-date-picker", { key: 'b45fba5a5fdf01f2bdbe774f1123012b98eeb2ab', standaloneAppearance: false, locale: this.locale, onDateChange: (e) => {
                e.stopPropagation();
                this.currentRangeValue = Object.assign(Object.assign({}, e.detail), { id: 'custom' });
                this.datePickerTouched = true;
            }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, range: this.range, from: this.from || ((_b = this.currentRangeValue) === null || _b === void 0 ? void 0 : _b.from), to: this.to || ((_c = this.currentRangeValue) === null || _c === void 0 ? void 0 : _c.to), minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex }), index.h("div", { key: '66e6a835d23b3308df952ad924fc8a095893a9e9', class: "pull-right" }, index.h("ix-button", { key: 'facd509b601f962bcca5e8363320ce392dd9e582', onClick: () => {
                if (this.currentRangeValue) {
                    this.onDateSelect(this.currentRangeValue);
                }
            } }, this.i18nDone))))))))));
