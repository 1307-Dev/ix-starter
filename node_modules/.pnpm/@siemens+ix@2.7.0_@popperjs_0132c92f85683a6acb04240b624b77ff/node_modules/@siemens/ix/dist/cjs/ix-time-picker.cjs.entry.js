...
const TimePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a9eea8ba01f8940e304d9065845dd6f5923ca784' }, index.h("ix-date-time-card", { key: 'de3136df6e519f43d7164eb1c3cdabdbbc5b35fb', standaloneAppearance: this.standaloneAppearance, corners: this.corners }, index.h("div", { key: '263f27a4dc56db9dc2346a2523a5d4825a208488', class: "header", slot: "header" }, index.h("ix-typography", { key: '84e671c788e95d62efd7c34fd31869e3b32116a3', format: "h5" }, this.textTime || 'Time')), index.h("div", { key: '13289eb12c718454912753192d7b0acd7a122385', class: "clock" }, timepickerInformation.map((descriptor, index$2) => (index.h("div", { class: "flex" }, index.h("div", { class: { columns: true, hidden: descriptor.hidden } }, index.h("ix-icon-button", { size: "16", onClick: () => {
                var _a;
                return (this._time = (_a = this._time) === null || _a === void 0 ? void 0 : _a.plus({
                    [descriptor.unit]: 1,
                }));
            }, ghost: true, icon: index$1.iconChevronUpSmall, variant: "primary", class: "arrows" }), index.h("input", { class: "form-control", name: descriptor.unit, type: "number", placeholder: descriptor.placeholder, value: this._formattedTime
            ...
            }, ghost: true, icon: index$1.iconChevronDownSmall, variant: "primary", class: "arrows" })), index$2 !== timepickerInformation.length - 1 && (index.h("div", { class: {
                'column-seperator': true,
                hidden: descriptor.hidden,
            } }, ":"))))), index.h("div", { key: '247a556182b1bae21b5aae99eaf42de20d15084a', class: {
                columns: true,
                'default-space': true,
                hidden: this._timeRef === undefined,
            } }, index.h("ix-icon-button", { key: 'b2e0a18822edaec9a2251968371c249b14dfc833', size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: index$1.iconChevronUp, variant: "primary", class: "arrows" }), index.h("div", { key: '5018f8b8b4e9ccf8697f8be6de98a882e2e83b0a', class: "time-reference" }, this._timeRef), index.h("ix-icon-button", { key: '9a457392dbe1ab7767897031175b826e53ffdc1a', size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: index$1.iconChevronDown, variant: "primary", class: "arrows" }))), index.h("div", { key: 'f97622c4cb4459b925662732191ed9009db61042', class: {
                button: true,
                hidden: !this.standaloneAppearance,
                standalone: true,
            } }, index.h("ix-button", { key: 'f3241730297ca6db973626ef35dddb9913922742', onClick: () => {
                var _a, _b;
