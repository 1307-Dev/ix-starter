...
const MapNavigation = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba41878a23093475533042d9a4ba4cfd16a37893' }, index.h("slot", { key: 'f65ea5d5ebf9543216f1786a147cdd3fda54bee0', name: "menu" }), index.h("div", { key: '86908ea0b2be743f577b8cee84369db8221bd341', class: "map-nav" }, index.h("div", { key: 'f92f1db6cc25ce3db8b04b6e269fe8efddf8a5f9', class: "map-nav-sidebar" }, index.h("div", { key: 'c4332a42558bfecbc72b2c2b42e99a7553bba2cc', class: "map-nav-header" }, index.h("ix-application-header", { key: '69e211ad7403a7e8e07d26639be248aae4e894a1', name: this.applicationName, class: "map-nav-header-brand" }, index.h("slot", { key: 'b721fc8c3f21e5d1e7f6840f3fb10e1a5febbc30', slot: "logo", name: "logo" }))), index.h("div", { key: '23abf0ad64887cd90edb757cde71db08b872a00e', class: "map-nav-sidebar-content" }, index.h("div", { key: '5378b320ab76b6613518336c60e7addd2598b599', class: "map-nav-sidebar-static-content" }, index.h("div", { key: 'f7f1638e6efcefb36a5786203a6d98283ce17947', class: "map-nav-title" }, this.navigationTitle), this.hideContextMenu ? ('') : (index.h("ix-icon-button", { icon: 'context-menu', ghost: true, size: "24", variant: "secondary", onClick: (_) => this.contextMenuClick.emit() }))), index.h("div", { key: '930d10792f23e6df31639ae959ec08b6e009085b', class: "map-nav-sidebar-user-content" }, index.h("slot", { key: '82f6edb84570324b0d9cf854fda4b280a7af6f15', name: "sidebar-content" })))), index.h("div", { key: '66e3e8a0408705b77bc220df8cf398f75f456de9', class: "content" }, index.h("div", { key: 'c8bf3586553e1f82c88f922f6c03d2aeeb7fe5af', class: {
                'map-nav-header-content': true,
                'bg-2': true,
                empty: !this.hasContentHeader,
            } }, index.h("slot", { key: '54050e2def4b2f5e9722fb01ec5821f97e9850e8', name: "content-header", onSlotchange: (e) => this.checkHasContentHeader(e) })), index.h("main", { key: 'f429b81681627e65628c35e002149425835d8fb3' }, index.h("slot", { key: 'e1103cdef2ccdf6a225afc2c61fa439779e1a540' }), index.h("slot", { key: '588bd4fe946d4d074af395c0ce92b971bf19da26', name: "overlay" }))))));
    }
