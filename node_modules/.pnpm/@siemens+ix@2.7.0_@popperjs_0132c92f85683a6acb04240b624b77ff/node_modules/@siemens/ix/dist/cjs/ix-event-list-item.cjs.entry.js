...
const EventListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dfeb360410eecdc5bd5881287a41106e1de5a81d', class: {
                disabled: this.disabled,
            } }, index.h("div", { key: '8ed103397f1e99a7e5bb59e9a8b90585c5e2263f', role: "listitem", "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                'event-list-item': true,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("div", { key: '0af7281c4f49763a0a9b879afd2bc58153b0ad20', class: `indicator ${!((_c = this.itemColor) !== null && _c !== void 0 ? _c : this.color) ? 'indicator-empty' : ''}`, style: {
                'background-color': ((_d = this.itemColor) !== null && _d !== void 0 ? _d : this.color) ? color : 'inherit',
                opacity: `${this.disabled ? 0.4 : 1}`,
            } }), index.h("div", { key: '470463df5f6c660c22492a8aac3ef7eceb130e17', class: "event-list-item-container" }, index.h("div", { key: '1e6a1104620b4284d86e81ad2d5e946044b395fb', class: "event-content" }, index.h("slot", { key: 'a13ac6b4c205d7ce2b10ba9a29e62175c61544ec' })), this.chevron && (index.h("ix-icon", { key: '0da6f24ce7c83bb8c144c8ac3170fb344954b2c2', name: 'chevron-right', size: "16", class: "chevron-icon" }))))));
    }
};
