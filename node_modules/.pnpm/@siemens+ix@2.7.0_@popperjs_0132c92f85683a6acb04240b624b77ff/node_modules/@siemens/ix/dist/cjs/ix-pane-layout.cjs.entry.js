...
const Panes = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0782cd76dbf14624b4d84b83251f6f65abad343e' }, !this.isMobile ? (this.layout == 'full-vertical' ? (index.h("div", { class: "side-panes-wrapper" }, index.h("div", { class: {
                row: true,
