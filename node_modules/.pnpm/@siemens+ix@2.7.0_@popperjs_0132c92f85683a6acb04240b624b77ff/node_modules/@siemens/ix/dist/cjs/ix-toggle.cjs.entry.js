...
const Toggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '508fa5cd92f3b3707823b13175a6e243def7d61f', class: {
                disabled: this.disabled,
            } }, index.h("label", { key: 'b01e8a3e4fb781dc979ebf915aa71055a688d0da', class: "wrapper" }, index.h("button", { key: '22301abf1c108d18d8c73d5288f9b6cceb6f4992', role: "switch", "aria-checked": a11y.a11yBoolean(this.checked), class: {
                switch: true,
                checked: this.checked,
                indeterminate: this.indeterminate,
            }, onClick: () => this.onCheckedChange(!this.checked) }, index.h("div", { key: '2f0a33aa378f39f77f7905028884b93b530e9c5e', class: "slider" })), index.h("input", { key: 'f5bb8b2a44d5881f769d2306b5eeadac9481dc46', type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11y.a11yBoolean(true), "aria-checked": a11y.a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && (index.h("ix-typography", { key: 'd631ef3c16f5df85c752534b4f1c798f520678d3', class: "label" }, toggleText)))));
    }
