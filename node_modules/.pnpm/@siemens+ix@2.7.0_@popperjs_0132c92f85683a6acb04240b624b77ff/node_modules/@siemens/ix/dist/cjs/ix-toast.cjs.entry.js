...
const Toast = class {
    ...
    getIcon() {
        ...
        switch (this.type) {
            case 'info':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: 'info', size: "24", color: "color-std-text" }));
            case 'error':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: 'error', size: "24", color: "color-alarm" }));
            case 'success':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: 'success', size: "24", color: "color-success" }));
            case 'warning':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: 'warning', size: "24", color: "color-warning" }));
            default:
                return '';
        }
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a8a6c1a009529dd1c61942c40a6d6d7081b319a0', class: "animate__animated animate__fadeIn" }, index.h("div", { key: 'fd011b4e26627fee1ee2917d7c22cbd039b67b67', class: "toast-body", onPointerLeave: () => {
                this.touched = false;
            }, onPointerEnter: () => {
                this.touched = true;
            } }, this.type || this.icon ? (index.h("div", { class: "toast-icon" }, this.getIcon())) : null, index.h("div", { key: '6ed6ffca2d27cd6e42c79d2250a1ec509db35ab5', class: "toast-content" }, this.toastTitle ? (index.h("div", { class: "toast-title" }, this.toastTitle)) : null, index.h("div", { key: '05f32e01c33421dc2356455d76805782d24f2164', class: "toast-message" }, index.h("slot", { key: 'e3d2457ca46a93df01d1dc69be829f30c40b9e8d' }))), index.h("div", { key: '55420cc44284a05c47069b55877233fbb9ce814c', class: "toast-close" }, index.h("ix-icon-button", { key: 'cd492967fb66313cb94ab460881e4c7275e03d9e', icon: 'close', size: "24", ghost: true, onClick: () => this.closeToast.emit() }))), this.autoClose ? (index.h("div", { class: progressBarClass.join(' '), style: progressBarStyle, onAnimationEnd: () => {
                this.close();
            }, onTransitionEnd: () => {
                if (this.progress === 0) {
                    this.close();
