...
const DatetimePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea71affcf0b1bbbd1808c7245ad30280288e67d6' }, index.h("ix-layout-grid", { key: '11af10aa4a2c7738c300ad0fc9130991f2d8b112', class: "no-padding" }, index.h("ix-row", { key: '46d0fad2121d415125de4a29c0815933a5e77303' }, index.h("ix-col", { key: 'a7c10cc24b94e622d11f0e33ac358616ec3cabdf' }, index.h("ix-date-picker", { key: '66051e5913c36d72e698e4baff451a81c22b12c1', ref: (ref) => (this.datePickerElement = ref), corners: "left", range: this.range, onDateChange: (event) => this.onDateChange(event), from: this.from, to: this.to, format: this.dateFormat, minDate: this.minDate, maxDate: this.maxDate, weekStartIndex: this.weekStartIndex, standaloneAppearance: false, locale: this.locale })), index.h("ix-col", { key: '0bb0946651287def31ff240279691cda09508436', class: "d-flex flex-column" }, index.h("ix-time-picker", { key: '31e8794aadbbd3945615b62e40bcec004891b99d', class: "min-width", ref: (ref) => (this.timePickerElement = ref), standaloneAppearance: false, showHour: this.showHour, showMinutes: this.showMinutes, showSeconds: this.showSeconds, onTimeChange: (event) => this.onTimeChange(event), format: this.timeFormat, time: this.time }), index.h("div", { key: 'dcb60b9dd749cf695212b5b1fc26d1762b45bd79', class: "btn-select-date-container" }, index.h("ix-button", { key: '2044c8aa877193340bd0f3cee8cc8a04c33c059b', class: "btn-select-date", onClick: () => this.onDone() }, this.textSelectDate || this.i18nDone)))))));
    }
};
