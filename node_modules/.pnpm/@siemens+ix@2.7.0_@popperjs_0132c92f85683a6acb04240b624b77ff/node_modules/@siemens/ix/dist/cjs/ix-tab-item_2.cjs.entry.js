...
const TabItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'aa3777497e986f80e8f6b5bffea01dc2df37f13b', class: this.tabItemClasses({
            ...
            } }, index.h("div", { key: '5efa7f3f34b94adfeec71af2c99d7f3f5833755f', class: {
                circle: this.rounded,
                text: !this.rounded,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("slot", { key: 'a7299d374904a1c0dada6733734e95c192e0789d' })), index.h("div", { key: '1f131f3b776e8a1911b68cfccee8f4864fe79e42', class: {
                counter: true,
                selected: this.selected,
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5757cc920ea2b89cc9939105053637dba7845d99' }, this.showArrowPrevious && (index.h("div", { key: '383591a874a69a2648f7442a45beab57d4e640f4', class: "arrow", onClick: () => this.move(this.scrollAmount, true) }, index.h("ix-icon", { key: '5473b2126b251e42c0764299ba34d7a99a53a3f1', name: 'chevron-left-small' }))), index.h("div", { key: 'f13e44ec54af45c4e1a98c33b9c3dfb8610d7ae0', class: {
                'tab-items': true,
            ...
            } }, index.h("div", { key: '5838bc0dc74ff67826446dde195b3b5040a6b425', class: "items-content" }, index.h("slot", { key: '0b5eb4c8273d8f603f739790d3ea1f4c2e139fde' }))), this.showArrowNext && (index.h("div", { key: '1037686d86fd6679d0a32c35397b28dac856930a', class: "arrow right", onClick: () => this.move(-this.scrollAmount, true) }, index.h("ix-icon", { key: 'cfa4efccdf75b7f0d30cbc1b9bb7694d2c70896e', name: 'chevron-right-small' })))));
    }
