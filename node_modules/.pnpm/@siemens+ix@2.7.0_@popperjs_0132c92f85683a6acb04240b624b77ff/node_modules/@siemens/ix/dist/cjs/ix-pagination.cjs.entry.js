...
const Pagination = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8f28dce6f49cf4b71ac337d5b721b6a10091999a' }, index.h("ix-icon-button", { key: '838b447430b77ba147efe3721340a2a425f31f2c', disabled: !this.count || this.selectedPage === 0, ghost: true, icon: 'chevron-left-small', onClick: () => this.decrease() }), this.advanced ? (index.h("div", { class: "advanced-pagination" }, index.h("ix-typography", { format: "body" }, this.i18nPage), index.h("input", { class: "form-control page-selection", type: "number", min: "1", max: this.count, value: this.selectedPage + 1, onChange: (event) => {
                const eventTarget = event.target;
                if (eventTarget) {
                    const index = Number.parseInt(eventTarget.value);
                    this.selectPage(index - 1);
                }
            } }), index.h("span", { class: "total-count" }, index.h("ix-typography", { format: "body" }, this.i18nOf, " ", this.count)))) : (index.h("span", { class: "basic-pagination" }, this.renderPageButtons(), " ")), index.h("ix-icon-button", { key: 'efcf14835418f853d90ba459372253ab213bf48d', disabled: !this.count || this.selectedPage === this.count - 1, ghost: true, icon: 'chevron-right-small', onClick: () => this.increase() }), this.advanced && this.showItemCount ? (index.h("span", { class: "item-count" }, index.h("ix-typography", { format: "body" }, this.i18nItems), index.h("ix-select", { hideListHeader: true, i18nPlaceholder: "", i18nSelectListHeader: "", value: `${this.itemCount}`, onValueChange: (e) => {
...
Pagination.style = IxPaginationStyle0;
