...
const baseButton = require('./base-button-119d9368.js');
const logicalFilterOperator = require('./logical-filter-operator-4917393f.js');
...
const CategoryFilter = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '0699ab3852828ebab616e66e11186338e84859ce' }, index.h("form", { key: 'db8980ec7f54ddd77eee511c2d50a1d575d41afd', ref: (el) => (this.formElement = el) }, index.h("div", { key: 'f5f0993cd2d3f0a1955f05ba46b001317fb68841', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, index.h("ix-icon", { key: '4b2f2b4bfbde91fec3753ac0e2fae58433c57466', color: this.getIconColor(), class: { 'd-none': this.hideIcon }, name: this.icon, size: "16" }), index.h("div", { key: 'd56117442c296412a0aef515e713c1e44aa60006', class: "token-container" }, index.h("div", { key: 'd494fd637dbba4cea32d4d7c014bd7369b16292d', class: "list-unstyled" }, this.filterTokens.map((value, index$1) => (index.h("span", { key: value.toString(), class: {
            ...
            } }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label)), index.h("input", Object.assign({ key: '43ff6f2894aeb82fae918dfc698f9d5acb57d740', class: {
                'text-input': true,
                'hide-placeholder': this.readonly || this.disabled || this.category !== '',
            }, autocomplete: "off", name: "category-filter-input", disabled: this.disabled, readonly: this.readonly, ref: this.textInput, type: "text", placeholder: this.placeholder }, this.a11yAttributes)))), !this.readonly && !this.disabled && this.getResetButton())), this.disabled || this.readonly ? ('') : (index.h("ix-dropdown", { show: this.showDropdown, closeBehavior: "outside", offset: { mainAxis: 2 }, anchor: (_b = this.textInput) === null || _b === void 0 ? void 0 : _b.waitForCurrent(), trigger: this.hostElement, header: this.getDropdownHeader() }, this.renderDropdownContent()))));
    }
