...
const DateInput = class {
    ...
    async onInput(value) {
        ...
        const date = luxon.DateTime_1.fromFormat(value, this.format);
        if (date.isValid) {
            this.isInputInvalid = false;
    ...
    renderInput() {
        return (index.h("div", { class: "input-wrapper" }, index.h(input_util.SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h("input", { autoComplete: "off", class: {
                ...
                this.openDropdown();
                this.ixFocus.emit();
            }, onBlur: () => this.ixBlur.emit() }), index.h(input_util.SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("ix-icon-button", { "data-testid": "open-calendar", class: { 'calendar-hidden': this.disabled || this.readonly }, ghost: true, icon: index$1.iconCalendar, onClick: (event) => this.onCalenderClick(event) }))));
    }
    ...
    render() {
        ...
        const invalidText = this.isInputInvalid
            ...
            : this.invalidText;
        return (index.h(index.Host, { key: '06cbbfe78b4ca05d37804b38e88dd2255c4ca096', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: '9f87f71a0b3fc6c6d269a5efbd2b44ef36a44d1f', label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText: invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), index.h("ix-dropdown", { key: 'b579d26bf119985c0312e7265fc65907af5fd526', "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
                this.show = event.detail;
            } }, index.h("ix-date-picker", { key: '171da21a0ede7293e7f0d6504cdd7ca01e9348db', ref: this.datepickerRef, format: this.format, locale: this.locale, range: false, from: (_a = this.from) !== null && _a !== void 0 ? _a : '', onDateChange: (event) => {
...
//# sourceMappingURL=ix-date-input.cjs.entry.js.map