...
const index$1 = require('./index-12d386cf.js');
...
const Menu = class {
    ...
    async showAppSwitch() {
        ...
        if ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) {
            index$1.showAppSwitch(this.applicationLayoutContext.appSwitchConfig);
        }
    }
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '34acb4f7248d1fdd1dae9cd558ee8fbacf6ccb30', class: {
                expanded: this.expand,
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "menu" }, index.h("nav", { key: '92b517494803d6189be1614a04c7c6edb21ecd5a', class: {
                menu: true,
                expanded: this.expand,
            } }, index.h("div", { key: '565601177af87864f2d1512eadb11b5bcea2a5c3', class: "menu-buttons" }, this.breakpoint !== 'sm' && (index.h("ix-menu-expand-icon", { key: '860112657f5ebe5d7d2ab14b37868a4f1b13742f', breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu() })), this.breakpoint === 'sm' &&
            ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && (index.h("ix-icon-button", { key: 'fecb89a154c4ede9e6d4b09c78c4fb985ae13e37', onClick: () => {
                this.showAppSwitch();
            }, icon: "apps", ghost: true }))), index.h("div", { key: '11f0983e123eebe3a82866437c9b8479df109066', id: "menu-tabs", style: {
                display: 'contents',
            }, onClick: (e) => this.onMenuItemsClick(e) }, index.h("div", { key: 'd4d76fe04e690a63d76af4b8c84b7cb0b6edc852', class: "tabs-shadow-container" }, index.h("div", { key: '3c1626e1aac8d92d43969e7b39ecc3551863fee5', class: {
                'tabs--shadow': true,
                'tabs--shadow-top': true,
                'tabs--shadow--show': this.itemsScrollShadowTop,
            } }), index.h("div", { key: '2629b6c82d46e117077422cc9b500af773190398', class: {
                tabs: true,
                'show-scrollbar': this.expand,
            }, onScroll: () => this.handleOverflowIndicator() }, index.h("div", { key: '1cffcb3f33e4c8badffb6ddd775599ff6730bfe3', class: "menu-avatar" }, index.h("slot", { key: '5ea94f9820f30b00e60eea1ccfe8173882240d66', name: "ix-menu-avatar" })), index.h("slot", { key: '8a35be3679f329141cb25808ddb9823a7098bbed', name: "home" }), this.breakpoint !== 'sm' || !this.isHiddenFromViewport() ? (index.h("slot", null)) : null), index.h("div", { key: '2846791805325640f24db3868594f92705f103f8', class: {
                'tabs--shadow': true,
                'tabs--shadow-bottom': true,
                'tabs--shadow--show': this.itemsScrollShadowBottom,
            } }))), index.h("div", { key: '91e34e2c7fc757cca8c2c2b27b98d86a19a107c6', class: "bottom-tab-divider" }), this.settings ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showSettings,
            }, icon: 'cogwheel', onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings })) : null, index.h("div", { key: '5947d048b397e8526a329fd1e6e3a91e0acf8eb8', onClick: (e) => this.onMenuItemsClick(e) }, index.h("slot", { key: '4c0329d3a438da60058f0d39ff5fb27f4700930c', name: "bottom" })), index.h("div", { key: '846223c5ffefc3f20bbf216af267201eee43a483', id: "popover-area" }), this.about ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showAbout,
            }, icon: 'info', onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal })) : null, this.enableToggleTheme ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: 'light-dark', label: this.i18nToggleTheme })) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() })) : null), index.h("div", { key: 'b626b582889704483c57da30d427646f3860350e', class: {
                'menu-overlay': true,
                ...
                this.checkTransition();
            } }, index.h("div", { key: '0992a73e9576c1d59c2aaeea3c56d1be08df9506', class: 'menu-overlay-container' }, this.showSettings ? index.h("slot", { name: "ix-menu-settings" }) : null), index.h("div", { key: 'd762f782b8d129ae7337e5a8d99e8b123cd3afcb', class: 'menu-overlay-container' }, this.showAbout ? index.h("slot", { name: "ix-menu-about" }) : null))));
    }
