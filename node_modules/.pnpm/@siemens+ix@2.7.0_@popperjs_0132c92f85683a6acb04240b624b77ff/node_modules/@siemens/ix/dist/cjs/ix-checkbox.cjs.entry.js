...
const IxCheckboxStyle0 = checkboxCss;
...
const Checkbox = class {
    ...
    renderCheckmark() {
        if (this.checked) {
            return (index.h("svg", { width: "18", height: "18", viewBox: "0 0 18 18", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M3.65625 8.15625L8.4375 12.9375L14.625 3.9375", stroke: "var(--ix-checkbox-check-color)", "stroke-width": "2" })));
        }
        if (this.indeterminate) {
            return (index.h("svg", { width: "18", height: "18", viewBox: "0 0 18 18", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("rect", { width: "18", height: "18", fill: "transparent" }), index.h("rect", { x: "3", y: "8", width: "12", height: "2", fill: "var(--ix-checkbox-check-color)" })));
        }
    }
    render() {
        return (index.h(index.Host, { key: '9f2dfb28e104211b4c74190ce34782e927c359be', "aria-checked": a11y.a11yBoolean(this.checked), "aria-disabled": a11y.a11yBoolean(this.disabled), role: "checkbox", class: {
                disabled: this.disabled,
                checked: this.checked,
                indeterminate: this.indeterminate,
            } }, index.h("label", { key: 'f5e2ae66239974ec5f91c1898b3c82a8efc06178' }, index.h("input", { key: '465622f5215ebb9bf62f7d6a44adfd55dbeb251a', "aria-checked": a11y.a11yBoolean(this.checked), disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), index.h("button", { key: '3e16d5cb70ecdb1c46f3ec05d87708dce31cc32a', disabled: this.disabled, class: {
                checked: this.checked,
            }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), index.h("ix-typography", { key: 'a525f43a85e83bb23ddb204afa2b5600a0441c2d', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, index.h("slot", { key: '531c5b1a6bb0748e59e378c898de733cc13da0c5' })))));
    }
...
Checkbox.style = IxCheckboxStyle0;
