...
const Dropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8ccd91cbff6fc3cfe77c369d6ee2ad5464df461c', "data-ix-dropdown": this.localUId, class: {
                'dropdown-menu': true,
                show: this.show,
            ...
            }, role: "list", onClick: (event) => this.onDropdownClick(event) }, index.h("div", { key: '80073881481da6170c687826f15f9dce0c457772', style: { display: 'contents' } }, this.header && index.h("div", { key: '40c656a8faf9685aaf4cd3145201e3a2be43f49e', class: "dropdown-header" }, this.header), this.show && index.h("slot", { key: 'f0a946a7223b1246ada013e6204adba613a0f758' }))));
    }
