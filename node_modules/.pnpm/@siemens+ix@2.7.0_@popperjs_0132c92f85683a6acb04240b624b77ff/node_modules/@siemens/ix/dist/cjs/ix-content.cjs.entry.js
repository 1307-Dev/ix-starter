...
const Content = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5ff3dde4c94bd5f40598a6b8fc9043ab2755c9a7' }, index.h("div", { key: 'cb2d5d8d011649e5f2cb67d8b7857b7bd096ca44', class: {
                'content-header': true,
                slotted: this.isContentHeaderSlotted,
            } }, index.h("slot", { key: '1a0c6b612ff4364e6bdd10b15745160925b61efd', name: "header", onSlotchange: () => {
                this.isContentHeaderSlotted = shadowDom.hasSlottedElements(this.contentHeaderSlot);
            } })), index.h("div", { key: '5eabaf6bcd0c33d982bd1b88862873383b58fae6', class: "content" }, index.h("slot", { key: '25fa713021e9c01c08282da185c2fc14b6d06b3f' }))));
    }
