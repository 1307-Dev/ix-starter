...
const SplitButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '816824c8c9642cd1620894baeda6c3227bebb371' }, index.h("div", { key: '251feccf5992525d8544085541fe1eefe455b3ac', class: { 'btn-group': true, 'middle-gap': !this.outline } }, this.label ? (index.h("ix-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }), this.label)) : (index.h("ix-icon-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }))), index.h("ix-icon-button", Object.assign({ key: '4cd4ced7be125a33bf978c4a252901ffa2b822eb' }, buttonAttributes, { ref: (r) => (this.triggerElement = r), class: 'anchor', icon: this.splitIcon }))), index.h("ix-dropdown", { key: 'a0a01f2b7dd0684ebfc53cfff55fa7c24c595b66', ref: (r) => (this.dropdownElement = r), closeBehavior: this.closeBehavior }, index.h("slot", { key: '2c653cd56349aa56c269b3e59a63dfea549b4165' }))));
    }
