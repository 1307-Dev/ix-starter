...
import { B as BaseIconButton } from './base-icon-button-38e2f6e6.js';
import { g as getFallbackLabelFromIconName } from './a11y-b10c12e0.js';
import './base-button-845f2463.js';
...
const IconButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3091c9758d6693c028e1cdc757bbf7e4daf7be3d', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, h(BaseIconButton, Object.assign({ key: '9cdb02f93735e8a2eb0a165bd6459d3e2b4b11d9' }, baseButtonProps))));
    }
...
const Spinner = class {
    ...
    render() {
        return (h(Host, { key: 'c83cb66db02c37e6c6039d0b52c78abb59112f3a' }, h("div", { key: '7d7179876635f26061798546fc1cf45f1311fba5', class: {
