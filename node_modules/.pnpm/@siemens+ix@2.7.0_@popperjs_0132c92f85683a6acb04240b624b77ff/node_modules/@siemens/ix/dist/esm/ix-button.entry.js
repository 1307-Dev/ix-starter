...
const Button = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'dce7bc83febc68f17b995b03bae8313bc984ded9', tabindex: this.disabled ? -1 : 0, class: {
                disabled: this.disabled || this.loading,
            }, onFocus: () => this.setFocus() }, h(BaseButton, Object.assign({ key: 'd7a6db5c7cb1952abcbb2c5192eb22914ba0fe09' }, baseButtonProps), h("slot", { key: '5fe5afdd6081641872b63d9a9a9a5909e72d6f0b' }))));
    }
