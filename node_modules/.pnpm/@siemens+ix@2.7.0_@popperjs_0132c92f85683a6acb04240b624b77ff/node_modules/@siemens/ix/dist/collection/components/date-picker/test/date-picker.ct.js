...
test('translation', async ({ mount, page }) => {
    ...
    await page.$eval(DATE_PICKER_REWORK_SELECTOR, (el) => {
        el.locale = 'de';
    });
...
test.describe('date picker tests single', () => {
    test.beforeEach(async ({ mount }) => {
        await mount(`<ix-date-picker min-date="2024/10/10" from="2024/10/10" range="false"></ix-date-picker>`);
    });
...
test.describe('date picker tests single', () => {
    test.beforeEach(async ({ mount }) => {
        await mount(`<ix-date-picker from="2023/09/05" range="false"></ix-date-picker>`);
    });
...
test.describe('date picker tests range', () => {
    test.beforeEach(async ({ mount }) => {
        await mount(`<ix-date-picker from="2023/09/05" to="2023/09/10"></ix-date-picker>`);
    });
...
//# sourceMappingURL=date-picker.ct.js.map
