...
test('renders in shadow DOM', async ({ mount, page }) => {
    ...
    await page.evaluate(() => {
        ...
        (_a = document.querySelector('#mount')) === null || _a === void 0 ? void 0 : _a.appendChild(testComponent);
        (_b = testComponent.shadowRoot) === null || _b === void 0 ? void 0 : _b.appendChild(button);
        (_c = testComponent.shadowRoot) === null || _c === void 0 ? void 0 : _c.appendChild(tooltip);
    });
    const tooltip = page.locator('ix-tooltip');
    const button = page.locator('ix-button');
    await button.hover();
...
test('avoid double visibility request by focusin event', async ({ mount, page, }) => {
    await mount(`
    <ix-menu>
