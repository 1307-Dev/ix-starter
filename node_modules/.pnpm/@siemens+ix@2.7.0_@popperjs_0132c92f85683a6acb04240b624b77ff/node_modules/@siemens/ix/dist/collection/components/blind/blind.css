...
:host(.blind-notification) .blind-header:not(.disabled):not(:disabled):hover, :host(.blind-notification) .blind-header:not(.disabled):not(:disabled):hover {
  background-color: var(--theme-color-notification--hover);
}
:host(.blind-notification) .blind-header:not(.disabled):not(:disabled) {
  cursor: pointer;
}
