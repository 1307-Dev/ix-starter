...
import { d as defineCustomElement$6 } from './menu-expand-icon.js';
...
const Menu = /*@__PURE__*/ proxyCustomElement(class Menu extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '34acb4f7248d1fdd1dae9cd558ee8fbacf6ccb30', class: {
            ...
            ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && (h("ix-icon-button", { key: 'fecb89a154c4ede9e6d4b09c78c4fb985ae13e37', onClick: () => {
                this.showAppSwitch();
