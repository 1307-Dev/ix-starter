...
import { o as iconMinus, p as iconPlus } from './index3.js';
import { H as HookValidationLifecycle } from './validation.js';
import { m as makeRef } from './make-ref.js';
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotStart, I as InputElement, d as checkAllowedKeys, o as onInputBlur, c as SlotEnd, e as checkInternalValidity } from './input.util.js';
import { d as defineCustomElement$7 } from './field-label.js';
import { d as defineCustomElement$6 } from './field-wrapper.js';
...
const NumberInput = /*@__PURE__*/ proxyCustomElement(class NumberInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IxNumberInputStyle0; }
}, [65, "ix-number-input", {
        "name": [513],
        "placeholder": [513],
        "value": [1538],
