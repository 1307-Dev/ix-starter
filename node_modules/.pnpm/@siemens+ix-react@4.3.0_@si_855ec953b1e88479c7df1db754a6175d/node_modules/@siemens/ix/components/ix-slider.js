...
import { d as defineCustomElement$5 } from './p-BHD2m8UF.js';
import { d as defineCustomElement$4 } from './p-D-nChuuk.js';
...
const Slider = /*@__PURE__*/ proxyCustomElement(class Slider extends H {
    ...
    render() {
        ...
        }))), h("input", Object.assign({ key: '1f1304342e72682bc040994e96297a31a61f4d00', id: "slider", ref: this.controlRef, type: "range", list: this.marker ? 'markers' : undefined, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
...
function defineCustomElement$1() {
    ...
    const components = ["ix-slider", "ix-field-label", "ix-field-wrapper", "ix-tooltip", "ix-typography"];
