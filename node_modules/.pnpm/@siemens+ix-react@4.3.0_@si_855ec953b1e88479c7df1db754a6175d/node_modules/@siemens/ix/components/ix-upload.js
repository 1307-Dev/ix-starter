...
import { d as defineCustomElement$3 } from './p-C5dktNss.js';
...
const Upload = /*@__PURE__*/ proxyCustomElement(class Upload extends H {
    ...
    render() {
        ...
        return (h(Host, Object.assign({ key: '00c05373c715388a90804b8b2eabf689d60acc0f' }, a11y, { "aria-disabled": disabled }), h("div", { key: '66db4112acaab05bde6107578684e3a1fb1de614', class: {
            ...
            }, accept: this.accept, disabled: disabled }), h("ix-button", { key: 'e8993aa0d8a3b07dfdc49f3d6c8616b5ce2e89a0', variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled: disabled }, this.i18nUploadFile)))));
    }
