...
import { createClassMutationObserver, } from "../utils/input";
/**
 * @form-ready
 */
export class Radio {
        ...
        return {
            ...
            "required": {
                ...
                "docs": {
                    ...
                    "text": "Requires the radio component and its group to be checked for the form to be submittable"
                },
                "getter": false,
                "setter": false,
                "reflect": true,
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Event emitted when the radio is blurred"
                },
                "complexType": {
                    "original": "void",
                    "resolved": "void",
    ...
    static get methods() {
        return {
            "setCheckedState": {
                "complexType": {
                    "signature": "(newChecked: boolean) => Promise<void>",
                    "parameters": [{
                            "name": "newChecked",
                            "type": "boolean",
                            "docs": ""
