...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '406a4e193377deed02588cf4472f5a9cdadee3f2', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: 'cc104d9630112c8d688417accf37b0e94f1bd1c1', htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: 'ddf0d5030a06eb966a6853ada6ab52ad0c2661d2', class: "input-wrapper" }, index.h(input_fc.SlotStart, { key: 'e3cec3c75def9eef6fd0b66a28ac5e844663a813', slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h(input_fc.InputElement, { key: '78fcf785c85c7260ac7d04e7e6e63e14dacba886', id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => input_fc.checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
                input_fc.onInputBlur(this, this.inputRef.current);
                this.touched = true;
            }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : undefined, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), index.h(input_fc.SlotEnd, { key: '3f3add18b0970f05509463b7fcccc64bf06cae96', slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("ix-icon-button", { key: 'adc28dadd45db5e1cd2ba351aca4478585b4d850', color: "color-weak-text", class: {
                'password-eye': true,
            ...
            } }))), !!this.maxLength && this.maxLength > 0 && (index.h("ix-typography", { key: '0990225bc71107d2863aef15564fee5bef14a7b0', class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : '').length, "/", this.maxLength)))));
    }
