...
var baseIconButton = require('./base-icon-button-BMxa9fiN.js');
var a11y = require('./a11y-B_6chCvu.js');
require('./base-button-DVckB2S-.js');
...
const IconButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2acf097d64918e4f19ead5560414cb07e791fe8c', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, index.h(baseIconButton.BaseIconButton, Object.assign({ key: 'b7e2432d7cc3362048c1e65d642e3abef43dec82' }, baseButtonProps))));
    }
...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8aa6edb9059ebaafe7f052083ca680c2bc5df2cc' }, index.h("div", { key: 'ef628ecd03a1a6b3cdd36d90fb60676fc03fc90d', class: {
