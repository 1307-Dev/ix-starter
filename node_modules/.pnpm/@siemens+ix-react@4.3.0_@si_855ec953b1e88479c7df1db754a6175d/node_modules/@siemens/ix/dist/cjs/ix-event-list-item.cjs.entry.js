...
const EventListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3fa7304c0d114cd65b572e6d7e1a7362d3f63950', class: {
                disabled: this.disabled,
                [`event-list-item-${this.variant}`]: true,
            } }, index.h("div", { key: '9dc5734ea43068e74efc45d89a6fda3bad040cd1', role: "listitem", "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                'event-list-item': true,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("div", { key: '5fc29826643c430d3f0c82826142b461395d5075', class: `indicator ${!this.itemColor ? 'indicator-empty' : ''}`, style: {
                'background-color': this.itemColor ? color : 'inherit',
                opacity: `${this.disabled ? 0.4 : 1}`,
            } }), index.h("div", { key: 'c53b6ea99b0744dc6a0d57024853d0627a3963e2', class: "event-list-item-container" }, index.h("div", { key: '22a50db11d9997caa9df67fea550e1f58224344c', class: "event-content" }, index.h("slot", { key: '6361d1b0c326919f46ed7eb1b6bcb4b17421258e' })), this.chevron && (index.h("ix-icon", { key: 'edd5d1e1ef0fa1c85b319f9bdccdf1e2cbe8183a', name: index$1.iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))))));
    }
};
