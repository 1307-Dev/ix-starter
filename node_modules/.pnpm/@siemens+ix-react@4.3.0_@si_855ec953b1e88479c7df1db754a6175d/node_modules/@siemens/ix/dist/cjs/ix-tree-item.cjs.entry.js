...
const TreeItem = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '0f615d72d15f5d10c9d44ea3bda96bb64494944a', class: {
                selected: !!((_a = this.context) === null || _a === void 0 ? void 0 : _a.isSelected),
            } }, index.h("div", { key: 'ea65a20109ff5347f1e6aa7da01f105f28594256', class: "icon-toggle-container" }, this.hasChildren ? (index.h("ix-icon", { name: index$1.iconChevronRightSmall, size: "24", class: {
                ['icon-toggle-down']: !!((_b = this.context) === null || _b === void 0 ? void 0 : _b.isExpanded),
            }, color: "color-std-text", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.toggle.emit();
            }, "aria-label": this.ariaLabelChevronIcon })) : null), index.h("div", { key: 'aba0519a308a75609a1339ec1d2ab7a6fcd4638e', class: "tree-node-container", onClick: () => {
                this.itemClick.emit();
            } }, index.h("div", { key: 'fa5985f1971f20cfb60f34e9c735c949e468ac4a', class: "tree-node-text" }, this.text), index.h("slot", { key: '9f1110d6d2d64af7cf2840fa429ccf7ed312e5fc' }))));
    }
};
