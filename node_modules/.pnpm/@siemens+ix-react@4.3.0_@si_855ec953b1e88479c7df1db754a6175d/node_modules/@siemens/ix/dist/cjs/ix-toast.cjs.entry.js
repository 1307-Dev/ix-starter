...
const Toast = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0e762b008a6695e9ecae1ffb288e606d9e9794c4', class: "animate__animated animate__fadeIn" }, index.h("div", { key: 'da513d7fec310d67a020044650517f0e5a38d578', class: "toast-body", onPointerLeave: () => {
                this.touched = false;
            }, onPointerEnter: () => {
                this.touched = true;
            } }, (this.type || this.icon) && !this.hideIcon ? (index.h("div", { class: "toast-icon" }, this.getIcon())) : null, index.h("div", { key: '56a6a8392b19e151c3f44b677168f105fe4a8114', class: "toast-content" }, this.toastTitle ? (index.h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle)) : null, index.h("div", { key: '6607138845d5f8eda23d06cbe65e785495a1c714', class: "toast-message" }, index.h("slot", { key: '2a8e839c3d68287873498585f06e84854f6a3d77' })), index.h("div", { key: '1522e81b25a84de92ca8857bb3689bea7ae303bb', class: "toast-action" }, index.h("slot", { key: '95cd3cefd6035ea710926d7c34eb38501b0de4fb', name: "action" }))), index.h("div", { key: 'bc7fd1c5f9adf6b8fd4d3b0aefc6a493afa0db54', class: "toast-close" }, index.h("ix-icon-button", { key: 'd9014f1d8561ebeeadd747772cfcfe287ebb30c1', icon: index$1.iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && (index.h("div", { key: '851ff267cb3d1973c648d53709f45acbc4005306', class: progressBarClass.join(' '), style: progressBarStyle, onAnimationEnd: () => {
                this.close();
            }, onTransitionEnd: () => {
                if (this.progress === 0) {
                    this.close();
