...
const FlipTile = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a54038f2dbaeffac796822404e2d186c742a5357', class: {
            ...
            } }, index.h("div", { key: '0bf12231b1cdeb0afe41d9d45c06fdef4cdedaf4', class: "flip-tile-container" }, index.h("div", { key: '3e9da89ed0b9cf7595e4c1d317d21ed1b55aa9d7', class: "flip-tile-header" }, index.h("div", { key: 'd4e7cc2a8162254ea3c7c4a0a031346b7a35e3d9', class: "header-slot-container text-l-title" }, index.h("slot", { key: 'dd9e2244a75179ceb4ac9647b403a5e2b01fd2ae', name: "header" })), index.h("ix-icon-button", { key: '74a5abdba3bf0c90222fc7bf7064742c0ea85b80', icon: index$1.iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), index.h("div", { key: '636884dbf0b0143e4f30061cd6e0472c83fe698a', class: "content-container" }, index.h("slot", { key: 'b94b3a488e7a137b06505290ab351724c5f01fca' })), index.h("div", { key: 'a15153c86848df2dd14b1423c686b9655d6fcdc1', class: {
                footer: true,
                'show-footer': this.hasFooterSlot,
            } }, index.h("slot", { key: '68d0585ff19d8a29fc8ccfdb2ec6302f767e3a94', name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) })))));
    }
