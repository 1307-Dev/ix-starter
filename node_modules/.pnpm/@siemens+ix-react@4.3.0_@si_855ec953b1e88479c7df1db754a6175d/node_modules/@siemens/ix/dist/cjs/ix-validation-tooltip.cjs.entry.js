...
const ValidationTooltip = class {
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h(index.Host, { key: '3bbb1884ba4d874e0187b0a649f8ffa276cd998f' }, index.h("slot", { key: '00503ee8eee8224d3cea5e94e1a73cd40ee4949e' }), index.h("div", { key: '27f89d9bf7edefd71ce731edf0e0a491ab3e2814', role: "tooltip", style: {
                display: 'none',
                position: 'fixed',
                top: '0',
                left: '0',
            ...
            }, class: "validation-tooltip text-default" }, this.message, index.h("slot", { key: '4b7d8a68f3e7efd19b166beea935210295afb6f6', name: "tooltip-message" }), index.h("div", { key: '3ab710662e09333589b25dd49c128b5cd1229843', id: "arrow" }))));
    }
