...
var index$2 = require('./index-CgfiBgkm.js');
...
const Menu = class {
    ...
    componentWillLoad() {
        ...
        this.themeDisposer = themeSwitcher.themeSwitcher.schemaChanged.on(() => {
            this.updateThemeState();
        });
    }
    componentDidRender() {
    ...
    updateThemeState() {
        const currentTheme = themeSwitcher.themeSwitcher.getCurrentTheme();
        this.isDarkMode = currentTheme.includes(themeSwitcher.themeSwitcher.suffixDark);
    }
    setPinned(pinned) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7908b3049bc1a6888ec28b1adf487c445a29bd70', class: {
                expanded: this.expand,
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "menu" }, index.h("nav", { key: 'f4cf27af13639bcf878b735a9e6b736fb64191ee', "aria-label": this.applicationName, class: {
                menu: true,
                expanded: this.expand,
            } }, index.h("div", { key: '0f62e241cf573b88b434be91c74aca94433f4193', class: "menu-buttons" }, this.breakpoint !== 'sm' && (index.h("ix-menu-expand-icon", { key: '035c270e6409bac89219b3e8d13f285f280dea82', breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" })), this.breakpoint === 'sm' &&
            ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && (index.h("ix-icon-button", { key: '15afec8a3ae367edf2a15aa17204c204fca4e557', onClick: () => {
                this.showAppSwitch();
            }, icon: index$1.iconApps, variant: "subtle-tertiary" }))), index.h("div", { key: '78f667ac88c651abe7a0c035b23e01c77a5b3597', id: "menu-tabs", style: {
                display: 'contents',
            }, onClick: (e) => this.onMenuItemsClick(e) }, index.h("div", { key: 'bb0ce756d9b06f762425afaa7d4fb117afc14cdc', class: "tabs-shadow-container" }, index.h("div", { key: 'c587ef53745dc5bd34898f1ea448f1822e3e5d61', class: {
                'tabs--shadow': true,
                'tabs--shadow-top': true,
                'tabs--shadow--show': this.itemsScrollShadowTop,
            } }), index.h("div", { key: 'bd01c9f1d6d55df8d2a99adc8265bcb2123394ae', class: {
                tabs: true,
                'show-scrollbar': this.expand,
            }, onScroll: () => this.handleOverflowIndicator() }, index.h("div", { key: '1eb6c9ff52ad626d4e662f1f94edfcc98e949044', class: "menu-avatar" }, index.h("slot", { key: '012eb4520d780e653b3b96d1d0278c839ce039b6', name: "ix-menu-avatar" })), index.h("slot", { key: '96b4d1055376c0a1cd462d1c2d8de82bc2d4b7bd', name: "home" }), this.breakpoint !== 'sm' || !this.isHiddenFromViewport() ? (index.h("slot", null)) : null), index.h("div", { key: '35f65a80ee3324ddac4d7c44e7d341aee870bfa1', class: {
                'tabs--shadow': true,
                'tabs--shadow-bottom': true,
                'tabs--shadow--show': this.itemsScrollShadowBottom,
            } }))), index.h("div", { key: '8efbab0c1961bc53e850d5a1da667866f8716462', class: "bottom-tab-divider" }), this.settings ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showSettings,
            }, icon: index$1.iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" })) : null, this.enableToggleTheme ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: index$1.iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() })) : null, index.h("div", { key: '0380616a60db7d5984af88c5a3edb1199184a27d', onClick: (e) => this.onMenuItemsClick(e) }, index.h("slot", { key: 'ee7506da4bdf9296e8477dea89d2e8f3dbc5d6b9', name: "bottom" })), index.h("div", { key: '5113ea04bed4ecc0a6a4a6bd1552d5ca8a1c5302', id: "popover-area" }), this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() })) : null, this.about ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showAbout,
            }, icon: index$1.iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" })) : null), index.h("section", { key: 'fa56100500bd7cbd4c6889c5541803ce9561f7d2', id: "menu-overlay", "aria-label": overlayLabel, class: {
                'menu-overlay': true,
                ...
                this.checkTransition();
            } }, index.h("div", { key: 'c716d09e64b870e38b171e9d7ab731409b14689a', class: 'menu-overlay-container' }, this.showSettings ? index.h("slot", { name: "ix-menu-settings" }) : null), index.h("div", { key: '08d767b2045d549520f75babeaaba23146cc9463', class: 'menu-overlay-container' }, this.showAbout ? index.h("slot", { name: "ix-menu-about" }) : null))));
    }
