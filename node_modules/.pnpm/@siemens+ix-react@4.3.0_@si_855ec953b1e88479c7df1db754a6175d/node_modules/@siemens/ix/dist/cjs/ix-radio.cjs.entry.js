...
const Radio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'be54688d35e7f4e27210a2ea9be675a4f3a9fcbd', "aria-checked": a11y.a11yBoolean(this.checked), "aria-disabled": a11y.a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
                ...
                if (this.disabled)
                    return;
                this.setCheckedState(true);
            }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, index.h("label", { key: '25b307478803a9a451ddb5bf799396682bb86dcf' }, index.h("div", { key: 'd8d5e9e24af3d32f1595308e323432747c5ab537', class: "radio-button" }, index.h("div", { key: '8ab8a79eaeb1bb388d4e541a2d79e54435f75432', "aria-hidden": "true", class: {
                ['radio-checkmark']: true,
                checked: this.checked,
            } }, index.h("div", { key: '9f4eb01307fa53d912d6ae3a36b337cd9b00da1b', class: "checkmark", style: { visibility: this.checked ? 'visible' : 'hidden' } }))), this.label && (index.h("ix-typography", { key: 'dc769fcfa28d4bf6555078db85d3709a47d1a50b', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, index.h("slot", { key: '08e71f05c95bfe2e45a1d47740e5ff851098c1ae' }))))));
    }
