...
const ToggleButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3d0e41a6571193d4b7d8e73701b6d295f4ab5482', class: {
                disabled: this.disabled || this.loading,
            } }, index.h(baseButton.BaseButton, Object.assign({ key: '770d156dbc007d146efbd7b5604b3c902197b4c2' }, baseButtonProps), index.h("slot", { key: '6d2a11909dcf61da1571d2e921e850d9a54ed95c' }))));
    }
};
