...
const MenuSettings = class {
    ...
    render() {
        return index.h(MenuTabs, { key: 'eefc53f1fa300794513f41b1bc80ac9fd00e295e', context: this });
    }
...
const MenuTabs = ({ context }) => {
    ...
    return (index.h(index.Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
            show: context.show,
        } }, index.h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' }, index.h("h2", { class: "text-h2" }, context.label), index.h("ix-icon-button", { variant: "tertiary", size: "24", icon: index$1.iconClose, iconColor: "color-soft-text", "aria-label": context.ariaLabelCloseButton, onClick: (e) => context.close.emit({
...
//# sourceMappingURL=ix-menu-settings-BYr52N4C.js.map
