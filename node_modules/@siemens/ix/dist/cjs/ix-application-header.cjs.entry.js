...
var index$1 = require('./index-CgfiBgkm.js');
...
const ApplicationHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f70c16368414080ba826e2009b1e0f3f65cb2ff1', class: {
                [`breakpoint-${this.breakpoint}`]: true,
                'hide-bottom-border': this.hideBottomBorder,
            }, slot: "application-header" }, index.h("div", { key: 'aa68f775dc1b58aafdf4b4d37700113fbc509e2d', class: "left-side" }, this.appIcon && this.breakpoint !== 'sm' && (index.h("div", { key: 'ae9b4672c1348d21c9c48421e867634af213a5c7', class: {
                'app-icon': true,
                'app-icon-outline': this.appIconOutline,
            } }, index.h("img", { key: '2bf6e28d9867f08a6d954e132ece2c149e20f1b5', src: this.appIcon, alt: this.appIconAlt }))), (this.showMenu || showMenuByApplicationFrame) && (index.h("ix-menu-expand-icon", { key: '64ba854155f4ab55ff7aa2f2b15b2feb19145a4e', onClick: () => this.onMenuClick(), expanded: this.menuExpanded })), showApplicationSwitch && (index.h("ix-icon-button", { key: '265abaec15030ee7dc41a1e0535f09e32b99ff01', onClick: () => this.showAppSwitch(), icon: index$2.iconApps, variant: "subtle-tertiary", class: {
                'app-switch': true,
                'without-app-icon': !this.appIcon,
            }, "aria-label": this.ariaLabelAppSwitchIconButton })), showCompanyLogoByProperty && (index.h("div", { key: '34e1ee388c68ec1e5a4c5ab0a67ae07f66d3b2ef', class: "logo" }, index.h("img", { key: '86bb6a77c06e0f30ce41de66a4fe813bc236b536', src: this.companyLogo, alt: this.companyLogoAlt }))), index.h("div", { key: '3391b44a0cdaaa1b8b60e29fe71c9f9a04473919', class: {
                logo: true,
                'hide-logo': !this.hasSlottedLogo,
            } }, index.h("slot", { key: 'e0e554af7fe4746a6b12ada015f0f129b96bdd76', name: "logo", onSlotchange: () => (this.hasSlottedLogo = this.checkLogoSlot()) })), index.h("div", { key: 'cf3bca529813307e538a13ddc454d01cce5a8689', class: "name" }, index.h("ix-typography", { key: '9e4d9c3b6a3f45e6ceba918bc17fd4ff4a5453c3', format: "body-lg", class: "application-name" }, this.name), this.nameSuffix && this.breakpoint !== 'sm' && (index.h("ix-typography", { key: '9f7780499e2fb19e622e16a4f7e46084e5713f68', format: "body-xs", class: "application-name-suffix" }, this.nameSuffix)))), index.h("div", { key: '3a4dee26b48e356c2652517dd88887d936f926d5', class: { 'right-side': true, sm: this.breakpoint === 'sm' } }, this.breakpoint !== 'sm' && (index.h("div", { key: 'fd961eea6ec62a745dc2b6c9842a7dcd777c9218', class: "secondary" }, index.h("slot", { key: 'c214a8d62f28268acb56f1ecb88115d82f14cf0a', name: "secondary" }))), index.h("div", { key: '48bb5fd5dbb93f25c933436ce5033fbb75db6962', class: "content" }, this.breakpoint !== 'sm' && index.h("slot", { key: '868289b10946d895af657afb22d047a2864a9e8a' }), index.h("ix-icon-button", { key: '6b83cf6c6f04a1435c21a6f1a61a54f82531db48', class: {
                'context-menu': true,
                'context-menu-visible': this.hasOverflowContextMenu || this.hasOverflowSlotElements,
            }, "data-context-menu": true, "data-testid": "show-more", icon: index$2.iconMoreMenu, variant: "subtle-tertiary", "aria-label": this.ariaLabelMoreMenuIconButton, "aria-hidden": a11y.a11yBoolean(!(this.hasOverflowContextMenu || this.hasOverflowSlotElements)) }), index.h("ix-dropdown", { key: 'e0c44a160fccfc5d02672b09abff3ea209df4056', "data-overflow-dropdown": true, class: "dropdown", discoverAllSubmenus: true, trigger: this.resolveContextMenuButton(), "aria-hidden": a11y.a11yBoolean(!(this.hasOverflowContextMenu || this.hasOverflowSlotElements)), enableTopLayer: this.enableTopLayer }, index.h("div", { key: 'd17c4e3695fdcc517272552b4420175dfbd2f2c8', class: "dropdown-content", onClick: (e) => this.onContentBgClick(e) }, this.breakpoint === 'sm' && (index.h("div", { key: '6e96017787c861308cd4dbcaca0312dd0601746b', class: {
                'slot-content': true,
                'slot-content-active': this.hasSecondarySlotElements,
            } }, index.h("slot", { key: 'd078fd257e64da944799047951c8b9ab2d762e0d', name: "secondary", onSlotchange: () => this.updateHasSlotAssignedElementsStates() }))), this.breakpoint === 'sm' && (index.h("div", { key: '64d3c501c11859ed9c27d3a8f64294a080925ca4', class: {
                'slot-content': true,
                'slot-content-active': this.hasDefaultSlotElements,
            } }, index.h("slot", { key: 'aa759b7edbfa50848887dc23e649ffe85fd296fa', onSlotchange: () => this.updateHasSlotAssignedElementsStates() }))), index.h("div", { key: 'caf2086cb213c9650e52df3433eac548a7a5510e', class: {
                'slot-content': true,
                'slot-content-active': this.hasOverflowSlotElements,
            } }, index.h("slot", { key: 'e4bf46ff49a8416e405513115db147994a2c6df6', name: "overflow", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })))), index.h("slot", { key: '17038a34906a10b5f0014a3f9f0e4bf8362f5695', name: "ix-application-header-avatar" })))));
    }
