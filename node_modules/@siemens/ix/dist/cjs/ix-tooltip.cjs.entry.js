...
const Tooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '55bcfd4bde42a8a34b4f07ac4c1006aea54ca7e5', role: "tooltip", class: { visible: this.visible } }, index.h("dialog", { key: 'ec321094408ffa410aeb3eca4180cbfccad52006', ref: this.dialogRef, id: 'tooltip-' + this.instance, class: "dialog", popover: "manual", inert: !this.visible }, index.h("div", { key: '509cdfa1685426e919ad692b3b44488c274c5836', class: "tooltip-container" }, index.h("div", { key: 'c575ea31e7c886efc0769ff2831837fdaacbdb2c', class: "content-wrapper" }, index.h("div", { key: 'c9b2ec82f0fa872f50e8692ad61000bad648e1a8', class: 'tooltip-title' }, index.h("slot", { key: '029bb99b659d5d392038041023a357f447d88d9b', name: "title-icon", onSlotchange: (e) => this.handleTitleIconSlotChange(e) }), index.h("ix-typography", { key: '3cfd52cca4147ebf5b793916c7acc991b8cf8095', format: "h5" }, this.titleContent, index.h("slot", { key: '88ba0fc44f93009be44bc7cb3b026dc8826533eb', name: "title-content" }))), index.h("slot", { key: '213e6a71172b01e58908016fed4aefa991c71b4c' }), index.h("div", { key: 'b63e112eb2f8ccf600dfab8eeebfb2bbcc7d8b33', class: "arrow" }))))));
    }
