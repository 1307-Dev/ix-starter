...
const Group = class {
    ...
    render() {
        return (index.h(index.Host, { key: '99b00ca8c88730036688974abd67ff0534dd4d17' }, index.h("div", { key: '47384431d36ce7cdc5a2e81ecd682d6a0dd13b53', class: {
                'group-header': true,
                expand: this.expanded,
                selected: this.selected,
            }, tabindex: "0" }, index.h("div", { key: '68968fc5816ca0fef0ae658a6925cc6b8ee3479a', class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, index.h("div", { key: 'a26153957aa76d882d95a3f88318c01517078a64', class: {
                'group-header-selection-indicator': true,
                'group-header-selection-indicator-item-selected': this.itemSelected,
            } }), index.h("div", { key: '01427b28c1b873a1875bd4c2093fee6d900bdf89', class: "btn-expand-header" }, index.h("ix-icon", { key: '1feb76e98b4ebda01d902b76065cdcefa0dde5a4', "data-testid": "expand-collapsed-icon", class: {
                hidden: !this.showExpandCollapsedIcon,
            }, name: this.expanded ? index$1.iconChevronUpSmall : index$1.iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), index.h("div", { key: '5c6232f9b9a36ccbfa2f0e9352a5e739e202e275', class: "group-header-content" }, this.header ? (index.h("div", { class: "group-header-props-container" }, index.h("div", { class: "group-header-title" }, index.h("span", { title: this.header }, this.header)), index.h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader))) : null, index.h("slot", { key: '592d03499639a45183c8837b421a33bbffbae954', name: "header" }))), this.hasDropdown && (index.h("ix-group-context-menu", { key: 'f666ce19d8441bd3afc40800128e6326da14615e' }, index.h("slot", { key: '96d9509e35fbf388d31fbc832fc31dd2167842a8', name: "dropdown" })))), index.h("div", { key: '3d6f649530d00fd19761bb84ed4bf8769b0bec14', class: {
                'group-content': true,
            } }, index.h("div", { key: 'cad4a7c42f5402400add10d1d5ac57174aa34b6e', style: {
                display: this.expanded ? 'contents' : 'none',
            } }, index.h("slot", { key: '305a97c24f58db1e1d1264876c99316aceda6e8d', onSlotchange: () => {
                var _a;
            ...
            } }), index.h("ix-group-item", { key: 'f19cce4aad2fc8465f57d94bb6a6b228204120e6', class: {
                footer: true,
                'footer-visible': this.footerVisible,
            }, groupFooter: true, suppressSelection: true }, index.h("slot", { key: 'c073314bc4528f7559c8c1cfa43b88881d7a4e49', name: "footer", onSlotchange: () => this.onSlotChange() }))))));
    }
