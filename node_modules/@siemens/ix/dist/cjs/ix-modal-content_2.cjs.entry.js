...
const ModalContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '60b3a1c2a24a678788c823dde41f743d9bfa5aa7' }, index.h("slot", { key: 'bba0935551ec0c9078c4ce867827bef053234cc2' })));
    }
};
...
const ModalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '05ede7c20a3b5cce70daba159f4b60c711697afb' }, this.icon ? (index.h("ix-icon", { name: this.icon, color: this.iconColor, size: "32", "aria-label": this.ariaLabelIcon })) : null, index.h("div", { key: '89e005b586e80c9f9a9642610d398b7511c50dd4', class: "modal-title" }, index.h("ix-typography", { key: '07728aa2ea936e5d5f10806211b4183c8a9ac171', format: "h5" }, index.h("slot", { key: '609defb48df9150be0d3d095a34659ad124be826' }))), !this.hideClose ? (index.h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), variant: "tertiary", icon: index$1.iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseIconButton })) : null));
    }
...
//# sourceMappingURL=ix-modal-content.ix-modal-header.entry.cjs.js.map
