...
const GroupContextMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd3b00dddd05f3ac944f61b8a4098883dffe2acc2' }, index.h("ix-icon-button", { key: '0d427b8b754020e83b4aa03686a9fea1d8fbffc0', class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: index$1.iconContextMenu }), index.h("slot", { key: 'baef7854222010ff76fc784c50804e4f343eafc3', onSlotchange: () => this.onSlotChange() })));
    }
...
const GroupItem = class {
    ...
    render() {
        if (this.groupFooter) {
            return (index.h(index.Host, { class: "suppress-mouse-states" }, index.h("div", { class: "group-footer" }, index.h("slot", null))));
        }
        return (index.h(index.Host, { class: {
                selected: this.selected && !this.suppressSelection,
            } }, index.h("button", { tabindex: this.disabled ? -1 : 0, disabled: this.disabled }, index.h("div", { class: "group-entry-selection-indicator" }), this.icon ? (index.h("ix-icon", { size: "16", name: this.icon, "aria-label": this.ariaLabelIcon })) : null, this.text ? (index.h("span", { class: "group-entry-text" }, index.h("span", { title: this.text }, this.text))) : null, this.secondaryText ? (index.h("span", { class: "group-entry-text-secondary" }, index.h("span", { title: this.secondaryText }, this.secondaryText))) : null, index.h("slot", null))));
    }
    get hostElement() { return index.getElement(this); }
};
