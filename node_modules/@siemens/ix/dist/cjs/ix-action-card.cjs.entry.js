...
const IxActionCard = class {
    ...
    render() {
        const ariaLabelledBy = !this.ariaLabelCard && this.heading
            ...
            : undefined;
        return (index.h(index.Host, { key: '600ad1913e671fb47ec9da8f66e984bbde498fae' }, index.h("ix-card", { key: '1a8168a17a643908126f841e9cdd6d0055a62399', selected: this.selected, variant: this.variant, passive: this.passive, class: 'pointer', "aria-label": this.ariaLabelCard, "aria-labelledby": ariaLabelledBy, role: ariaLabelledBy ? 'group' : undefined }, index.h("ix-card-content", { key: 'c138b94b131af478fee65244f32b91cdf78b31df' }, this.icon ? (index.h("ix-icon", { class: 'icon', name: this.icon, size: "32", "aria-label": this.ariaLabelIcon || a11y.getFallbackLabelFromIconName(this.icon) })) : null, index.h("div", { key: 'eb0252c628c75709fddae387a3b4a7abbf7c3df0' }, this.heading ? (index.h("ix-typography", { id: "ix-action-card-heading", "aria-hidden": a11y.a11yBoolean(!ariaLabelledBy), format: "h4" }, this.heading)) : null, this.subheading ? (index.h("ix-typography", { format: "h5", "text-color": this.getSubheadingTextColor() }, this.subheading)) : null, index.h("slot", { key: 'f47fd515fc5b8f22344dc83b808e527116238618' }))))));
    }
};
IxActionCard.style = actionCardCss;

exports.ix_action_card = IxActionCard;
//# sourceMappingURL=ix-action-card.entry.cjs.js.map
