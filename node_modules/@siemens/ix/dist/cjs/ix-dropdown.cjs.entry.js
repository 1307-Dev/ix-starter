...
const Dropdown = class {
    ...
    async applyDropdownPosition() {
        ...
        this.destroyAutoUpdate();
        this.autoUpdateCleanup = floatingUi_dom.autoUpdate(referenceElement, targetElement, async () => {
            const computeResponse = await floatingUi_dom.computePosition(referenceElement, targetElement, positionConfig);
    ...
    render() {
        if (this.enableTopLayer) {
            return (index.h(index.Host, { "data-ix-dropdown": this.localUId, class: {
                    'dropdown-menu': true,
                    show: this.show,
                } }, index.h("dialog", { ref: this.dialogRef, class: {
                    dialog: true,
                    overflow: !this.suppressOverflowBehavior,
                }, popover: "manual", "aria-modal": "true", "aria-label": this.header, tabindex: -1, onClick: (event) => this.onDropdownClick(event) }, index.h("div", { class: "dropdown-container" }, this.header && index.h("div", { class: "dropdown-header" }, this.header), this.show && index.h("slot", null)))));
        }
        return (index.h(index.Host, { "data-ix-dropdown": this.localUId, class: {
                'dropdown-menu': true,
                show: this.show,
            ...
            }, role: "list", onClick: (event) => this.onDropdownClick(event) }, index.h("div", { style: { display: 'contents' } }, this.header && index.h("div", { class: "dropdown-header" }, this.header), this.show && index.h("slot", null))));
    }
