...
const FilterChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e583d14307f98b55f1ff4be4b9c3897776eaae75', class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, index.h("div", { key: '998751b62b8266368176fe1186a6dd2f311199be', class: "slot-container" }, index.h("slot", { key: '2861044a08d5b237444cda5bb5fafe0bc0c97790' })), !this.disabled && !this.readonly ? (index.h("ix-icon-button", { variant: "tertiary", oval: true, icon: index$1.iconCloseSmall, size: "16", tabindex: this.disabled ? -1 : 0, disabled: this.disabled, onClick: (e) => this.onCloseClick(e), "aria-label": this.ariaLabelCloseIconButton })) : null));
    }
...
const SelectItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd471aafd061cccdd058502fb02f16aa79fd7d37b' }, index.h("ix-dropdown-item", { key: '6e57ba4665445e0ea0222f16177821a6fe53867e', class: {
