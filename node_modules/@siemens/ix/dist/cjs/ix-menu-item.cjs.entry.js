...
const MenuItem = class {
    ...
    render() {
        ...
        const hostA11y = a11y.a11yHostAttributes(this.hostElement);
        const commonAttributes = Object.assign({ class: 'tab', tabIndex: this.disabled ? -1 : 0 }, hostA11y);
        const menuContent = [
            this.icon && (index.h("ix-icon", { key: '3235cdce2773d33e6f1a75b4df395079246fa993', class: 'tab-icon', name: this.icon, "aria-hidden": "true" })),
            this.notifications ? (index.h("div", { class: "notification" }, index.h("div", { class: "pill" }, this.notifications))) : null,
            index.h("span", { key: '704284ed9ae6b83b2b2d65ebc103e5e8ff766c1b', id: this.internalItemId, class: "tab-text text-default" }, this.label, index.h("slot", { key: '6b79e39fb7e616088d11bd8b9c57f4406fdd94b6' })),
        ];
        return (index.h(index.Host, Object.assign({ key: '331694d5c502b1ed77035e591ffa5748777d8a81', class: {
                disabled: this.disabled,
                'home-tab': this.home,
                'bottom-tab': this.bottom,
                active: this.active,
                'tab-nested': this.isHostedInsideCategory,
            }, "aria-disabled": this.disabled ? 'true' : null }, extendedAttributes), this.href ? (index.h("a", Object.assign({}, commonAttributes, { href: this.disabled ? undefined : this.href, target: this.target, rel: this.rel, role: "button", ref: this.buttonRef, onClick: (e) => {
                if (this.disabled) {
                    e.preventDefault();
                    e.stopPropagation();
                }
            } }), menuContent)) : (index.h("button", Object.assign({}, commonAttributes, { ref: this.buttonRef }), menuContent)), index.h("ix-tooltip", { key: 'd282a68bce72435079cbfea5234b227c92027643', for: this.buttonRef.waitForCurrent(), placement: 'right', showDelay: 1000, interactive: false, "aria-hidden": a11y.a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip)));
    }
