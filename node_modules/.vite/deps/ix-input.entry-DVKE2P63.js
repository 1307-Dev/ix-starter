...
var Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "406a4e193377deed02588cf4472f5a9cdadee3f2", class: {
      ...
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "3f3add18b0970f05509463b7fcccc64bf06cae96", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "adc28dadd45db5e1cd2ba351aca4478585b4d850", color: "color-weak-text", class: {
      "password-eye": true,
...
//# sourceMappingURL=ix-input.entry-DVKE2P63.js.map
