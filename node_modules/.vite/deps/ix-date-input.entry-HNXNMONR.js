import {
  ...
  handleIconClick,
  openDropdown
} from "./chunk-RM75DJDM.js";
import "./chunk-L3Q5OFU3.js";
import {
  SlotEnd,
  SlotStart,
...
} from "./chunk-YB5ZZUBO.js";
import {
  DateTime
} from "./chunk-VBDKSUBD.js";
import {
  HookValidationLifecycle,
  createClassMutationObserver,
  getValidationText
} from "./chunk-7VZXJ5ER.js";
import "./chunk-VAXRRPLD.js";
import {
  makeRef
} from "./chunk-6UMYS7LX.js";
import "./chunk-A4ZY2HLS.js";
import "./chunk-R4UWNGMD.js";
import "./chunk-PH6W5VKT.js";
import "./chunk-7VCGAJ5Y.js";
import {
  iconCalendar
} from "./chunk-FWTAETD4.js";
import {
  Host,
  createEvent,
  getElement,
...
var DateInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "d5b3002c72ba1337db71f7b03dda27865f4eccf8", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "395ca11b4cdb9e1e222a28065a23067eaa728849", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "0a5b68dcdc401200ea2e063a9eac74cb9bbda5fa", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-date-picker", { key: "c7a5b6b28719abdde0318af75260c7bc6bb190d1", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: (_a = this.from) !== null && _a !== void 0 ? _a : "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
...
//# sourceMappingURL=ix-date-input.entry-HNXNMONR.js.map
