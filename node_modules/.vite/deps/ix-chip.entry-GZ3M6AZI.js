...
// node_modules/.pnpm/@siemens+ix@4.3.0_@siemens+ix-icons@3.4.0/node_modules/@siemens/ix/dist/esm/ix-chip.entry.js
...
var Chip = class {
  ...
  render() {
    ...
    return h(Host, { key: "89e8d6fc156f9b2b761000d213655b36f3b16bf2", tabIndex: "-1", class: {
      ...
      "with-icon": true
    }, name: this.icon, size: "24", style: this.variant === "custom" ? { color: this.outline ? this.background : this.chipColor } : void 0 }), h("span", { key: "e08beb2e151300bdcdfe62c0b6a832935a7d2f68", class: "slot-container" }, h("slot", { key: "b087848f9f85fc01af5cc3a03d4ae885e0f01335" }))), this.inactive === false && this.closable && this.getCloseButton()), this.getTooltip());
  }
  get hostElement() {
...
//# sourceMappingURL=ix-chip.entry-GZ3M6AZI.js.map
