// node_modules/.pnpm/@siemens+ix@4.3.0_@siemens+ix-icons@3.4.0/node_modules/@siemens/ix/dist/esm/a11y-Bb7pDeaQ.js
var isHttpUrl = (link) => {
  if (!link) {
    return false;
  }
...
var a11yBoolean = (value) => value ? "true" : "false";
var kebabCaseToUpperCaseSentence = (kebabCase) => {
...
var getFallbackLabelFromIconName = (iconName) => {
  if (!iconName) {
    return "Unknown";
  }
...
var a11yHostAttributes = (hostElement, ignoreAttributes = []) => {
...
//# sourceMappingURL=chunk-A4ZY2HLS.js.map
