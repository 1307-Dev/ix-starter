import {
  TypedEvent
} from "./chunk-3QPNF5UY.js";

// node_modules/.pnpm/@siemens+ix@4.3.0_@siemens+ix-icons@3.4.0/node_modules/@siemens/ix/dist/esm/context-BniHpAE1.js
...
var closestIxMenu = (element) => {
  const menuElement = element.closest("ix-menu");
  return menuElement;
};
var ApplicationLayoutContext = createContext("application-layout-context", {
  hideHeader: false,
  sidebar: false
});
...
//# sourceMappingURL=chunk-B7WRU2NN.js.map
